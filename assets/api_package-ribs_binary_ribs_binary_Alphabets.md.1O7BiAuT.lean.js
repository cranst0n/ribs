...
const __pageData = JSON.parse('{"title":"Alphabets","description":"API documentation for Alphabets class from ribs_binary","frontmatter":{"title":"Alphabets","description":"API documentation for Alphabets class from ribs_binary","category":"Classes","library":"ribs_binary","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_binary_ribs_binary/Alphabets.md","filePath":"api/package-ribs_binary_ribs_binary/Alphabets.md"}');
const _sfc_main = { name: "api/package-ribs_binary_ribs_binary/Alphabets.md" };
const _hoisted_1 = {
  id: "alphabets",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Alphabets ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#alphabets",
        "aria-label": 'Permalink to "Alphabets <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
    ...
    _cache[25] || (_cache[25] = createStaticVNode("", 50))
  ]);
}
const Alphabets = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Alphabets as default
};
