...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[23] || (_cache[23] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">Alphabet</span></code></pre></div><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/api/package-ribs_binary_ribs_binary/Base58Alphabet.html">Base58Alphabet</a></li><li><a href="/api/package-ribs_binary_ribs_binary/BinaryAlphabet.html">BinaryAlphabet</a></li><li><a href="/api/package-ribs_binary_ribs_binary/HexAlphabet.html">HexAlphabet</a></li><li><a href="/api/package-ribs_binary_ribs_binary/PaddedAlphabet.html">PaddedAlphabet</a></li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 3)),
