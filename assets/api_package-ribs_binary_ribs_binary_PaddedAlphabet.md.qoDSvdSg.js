...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[35] || (_cache[35] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">PaddedAlphabet</span> <span class="kw">extends</span> <a href="./Alphabet" class="type-link">Alphabet</a></code></pre></div><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/api/package-ribs_binary_ribs_binary/Alphabet.html">Alphabet</a> → <strong>PaddedAlphabet</strong></p></div><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/api/package-ribs_binary_ribs_binary/Base32Alphabet.html">Base32Alphabet</a></li><li><a href="/api/package-ribs_binary_ribs_binary/Base64Alphabet.html">Base64Alphabet</a></li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 4)),
