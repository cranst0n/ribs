...
const __pageData = JSON.parse('{"title":"State<S, A>","description":"API documentation for State<S, A> class from ribs_core","frontmatter":{"title":"State<S, A>","description":"API documentation for State<S, A> class from ribs_core","category":"Classes","library":"ribs_core","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_core_ribs_core/State.md","filePath":"api/package-ribs_core_ribs_core/State.md"}');
const _sfc_main = { name: "api/package-ribs_core_ribs_core/State.md" };
const _hoisted_1 = {
  id: "state-s-a",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("State<S, A> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#state-s-a",
        "aria-label": 'Permalink to "State\\<S, A\\> <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
    ...
    _cache[35] || (_cache[35] = createStaticVNode("", 29)),
    ...
    _cache[37] || (_cache[37] = createStaticVNode("", 14))
  ]);
}
