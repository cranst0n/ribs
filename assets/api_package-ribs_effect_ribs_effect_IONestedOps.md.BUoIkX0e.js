...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createStaticVNode('<h1 id="ionestedops-a" tabindex="-1">IONestedOps&lt;A&gt; <a class="header-anchor" href="#ionestedops-a" aria-label="Permalink to &quot;IONestedOps\\&lt;A\\&gt;&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">extension</span> <span class="fn">IONestedOps</span>&lt;A&gt; <span class="kw">on</span> <a href="./IO" class="type-link">IO</a>&lt;<a href="./IO" class="type-link">IO</a>&lt;<span class="type">A</span>&gt;&gt;</code></pre></div><p>Extension methods for <a href="/ribs/api/package-ribs_effect_ribs_effect/IO.html">IO</a> values that themselves produce an <a href="/ribs/api/package-ribs_effect_ribs_effect/IO.html">IO</a>.</p><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
