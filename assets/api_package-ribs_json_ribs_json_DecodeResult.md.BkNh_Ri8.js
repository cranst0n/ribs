...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [..._cache[0] || (_cache[0] = [
    createStaticVNode('<h1 id="decoderesult-a" tabindex="-1">DecodeResult&lt;A&gt; <a class="header-anchor" href="#decoderesult-a" aria-label="Permalink to &quot;DecodeResult\\&lt;A\\&gt;&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">typedef</span> <span class="fn">DecodeResult&lt;A&gt;</span> = <a href="../package-ribs_core_ribs_core/Either" class="type-link">Either</a>&lt;<a href="./DecodingFailure" class="type-link">DecodingFailure</a>, <span class="type">A</span>&gt;</code></pre></div>', 2)
  ])]);
}
