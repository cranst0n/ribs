...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[74] || (_cache[74] = createStaticVNode('<div class="member-signature"><pre><code><a href="./MagneticFluxDensity" class="type-link">MagneticFluxDensity</a> <span class="kw">get</span> <span class="fn">toMicroteslas</span></code></pre></div><p>Converts this to microteslas (µT).</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">MagneticFluxDensity</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toMicroteslas </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> to</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(microteslas).microteslas;</span></span></code></pre></div></details>', 3)),
    ...
    _cache[76] || (_cache[76] = createStaticVNode('<div class="member-signature"><pre><code><a href="./MagneticFluxDensity" class="type-link">MagneticFluxDensity</a> <span class="kw">get</span> <span class="fn">toNanoteslas</span></code></pre></div><p>Converts this to nanoteslas (nT).</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">MagneticFluxDensity</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toNanoteslas </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> to</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(nanoteslas).nanoteslas;</span></span></code></pre></div></details>', 3)),
    ...
    _cache[77] || (_cache[77] = createStaticVNode('<div class="member-signature"><pre><code><a href="./MagneticFluxDensity" class="type-link">MagneticFluxDensity</a> <span class="kw">get</span> <span class="fn">toTeslas</span></code></pre></div><p>Converts this to teslas (T).</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">MagneticFluxDensity</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toTeslas </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> to</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(teslas).teslas;</span></span></code></pre></div></details>', 3)),
