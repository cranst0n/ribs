import { o as openBlock, c as createElementBlock, e as createStaticVNode, _ as _export_sfc } from "./app.BI8hTGBT.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [..._cache[0] || (_cache[0] = [
    createStaticVNode('<h1 id="ribs-sqlite" tabindex="-1">ribs_sqlite <a class="header-anchor" href="#ribs-sqlite" aria-label="Permalink to &quot;ribs_sqlite&quot;">​</a></h1><h2 id="section-classes" tabindex="-1">Classes <a class="header-anchor" href="#section-classes" aria-label="Permalink to &quot;Classes {#section-classes}&quot;">​</a></h2><table tabindex="0"><thead><tr><th>Class</th><th>Description</th></tr></thead><tbody><tr><td><a href="/ribs/api/package-ribs_sqlite_ribs_sqlite/SqliteConnection.html">SqliteConnection</a></td><td></td></tr><tr><td><a href="/ribs/api/package-ribs_sqlite_ribs_sqlite/SqlitePoolTransactor.html">SqlitePoolTransactor</a></td><td>A <a href="/ribs/api/package-ribs_sql_ribs_sql/Transactor.html">Transactor</a> backed by a SQLite connection pool via the <code>sqlite3_connection_pool</code> package.</td></tr><tr><td><a href="/ribs/api/package-ribs_sqlite_ribs_sqlite/SqliteTransactor.html">SqliteTransactor</a></td><td>A <a href="/ribs/api/package-ribs_sql_ribs_sql/Transactor.html">Transactor</a> backed by an SQLite database via the <code>sqlite3</code> package.</td></tr></tbody></table>', 3)
  ])]);
}
