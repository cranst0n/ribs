...
const __pageData = JSON.parse('{"title":"Accumulator0<A, B>","description":"API documentation for Accumulator0<A, B> class from ribs_parse","frontmatter":{"title":"Accumulator0<A, B>","description":"API documentation for Accumulator0<A, B> class from ribs_parse","category":"Classes","library":"ribs_parse","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_parse_ribs_parse/Accumulator0.md","filePath":"api/package-ribs_parse_ribs_parse/Accumulator0.md"}');
const _sfc_main = { name: "api/package-ribs_parse_ribs_parse/Accumulator0.md" };
const _hoisted_1 = {
  id: "accumulator0-a-b",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Accumulator0<A, B> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#accumulator0-a-b",
        "aria-label": 'Permalink to "Accumulator0\\<A, B\\> <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    _cache[29] || (_cache[29] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">Accumulator0</span>&lt;A, B&gt; <span class="kw">extends</span> <a href="./Accumulator" class="type-link">Accumulator</a>&lt;<span class="type">A</span>, <span class="type">B</span>&gt;</code></pre></div><p>A zero-or-more accumulator: builds a result <code>B</code> from zero or more items of type <code>A</code>.</p><p>Extends <a href="/ribs/api/package-ribs_parse_ribs_parse/Accumulator.html">Accumulator</a> with an optional first element so that it can be used with <code>rep0</code>-style parsers, where the parse may succeed without consuming any input.</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_parse_ribs_parse/Accumulator.html">Accumulator&lt;A, B&gt;</a> → <strong>Accumulator0&lt;A, B&gt;</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-accumulator0" tabindex="-1">Accumulator0() <a class="header-anchor" href="#ctor-accumulator0" aria-label="Permalink to &quot;Accumulator0() {#ctor-accumulator0}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">Accumulator0</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 8)),
    ...
    createBaseVNode("h3", _hoisted_4, [
      _cache[11] || (_cache[11] = createTextVNode("newAppender() ", -1)),
      createVNode(_component_Badge, {
        type: "info",
        text: "override"
      }),
      ...
      _cache[13] || (_cache[13] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#newappender",
        "aria-label": 'Permalink to "newAppender() <Badge type="info" text="override" /> {#newappender}"'
      }, "​", -1))
    ]),
    _cache[32] || (_cache[32] = createStaticVNode('<div class="member-signature"><pre><code><a href="./Appender" class="type-link">Appender</a>&lt;<span class="type">A</span>, <span class="type">B</span>&gt; <span class="fn">newAppender</span>([<span class="type">A</span>? <span class="param">first</span>])</code></pre></div><p>Creates a new <a href="/ribs/api/package-ribs_parse_ribs_parse/Appender.html">Appender</a> seeded with <code>first</code>.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@override</span></span>\n<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Appender</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">B</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">newAppender</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">([</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">?</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> first]);</span></span></code></pre></div></details>', 3)),
    ...
    _cache[36] || (_cache[36] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./Accumulator0" class="type-link">Accumulator0</a>&lt;<span class="type">dynamic</span>, <a href="../package-ribs_core_ribs_core/Unit" class="type-link">Unit</a>&gt; <span class="fn">unit</span></code></pre></div><p>An <a href="/ribs/api/package-ribs_parse_ribs_parse/Accumulator0.html">Accumulator0</a> that discards all items and returns <a href="/ribs/api/package-ribs_core_ribs_core/Unit.html">Unit</a>.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Accumulator0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">dynamic</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Unit</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; unit </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> UnitAccumulator0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></details><h2 id="section-static-methods" tabindex="-1">Static Methods <a class="header-anchor" href="#section-static-methods" aria-label="Permalink to &quot;Static Methods {#section-static-methods}&quot;">​</a></h2><h3 id="ilist" tabindex="-1">ilist() <a class="header-anchor" href="#ilist" aria-label="Permalink to &quot;ilist() {#ilist}&quot;">​</a></h3><div class="member-signature"><pre><code><a href="./Accumulator0" class="type-link">Accumulator0</a>&lt;<span class="type">A</span>, <a href="../package-ribs_core_ribs_core/IList" class="type-link">IList</a>&lt;<span class="type">A</span>&gt;&gt; <span class="fn">ilist&lt;A&gt;</span>()</code></pre></div><p>An <a href="/ribs/api/package-ribs_parse_ribs_parse/Accumulator0.html">Accumulator0</a> that collects items into an <a href="/ribs/api/package-ribs_core_ribs_core/IList.html">IList</a>.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Accumulator0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">IList</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">ilist</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;() </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> IListAcc0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></details>', 8)),
    createBaseVNode("h3", _hoisted_9, [
      _cache[26] || (_cache[26] = createTextVNode("string() ", -1)),
      createVNode(_component_Badge, {
        type: "info",
        text: "override"
      }),
      ...
      _cache[28] || (_cache[28] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#string",
        "aria-label": 'Permalink to "string() <Badge type="info" text="override" /> {#string}"'
      }, "​", -1))
    ]),
    _cache[37] || (_cache[37] = createStaticVNode('<div class="member-signature"><pre><code><a href="./Accumulator0" class="type-link">Accumulator0</a>&lt;<span class="type">String</span>, <span class="type">String</span>&gt; <span class="fn">string</span>()</code></pre></div><p>An <a href="/ribs/api/package-ribs_parse_ribs_parse/Accumulator0.html">Accumulator0</a> that concatenates <a href="https://api.dart.dev/stable/3.11.5/dart-core/String-class.html" target="_blank" rel="noreferrer">String</a> items into a single <a href="https://api.dart.dev/stable/3.11.5/dart-core/String-class.html" target="_blank" rel="noreferrer">String</a>.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Accumulator0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">string</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">() </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> StringAcc0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></details>', 3))
  ]);
}
const Accumulator0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Accumulator0 as default
};
