...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[27] || (_cache[27] = createStaticVNode('<div class="member-signature"><pre><code><a href="../package-ribs_rill_ribs_rill/Rill" class="type-link">Rill</a>&lt;<a href="./Socket" class="type-link">Socket</a>&gt; <span class="kw">get</span> <span class="fn">accept</span></code></pre></div><p>A Rill of accepted client connections. Each emitted <a href="./Socket.html" class="api-link"><code>Socket</code></a> should be closed by the caller when done (e.g. via <a href="/api/package-ribs_effect_ribs_effect/Resource.html">Resource</a> or <a href="/api/package-ribs_effect_ribs_effect/IO.html#bracket">IO.bracket</a>).</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Rill</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Socket</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> accept;</span></span></code></pre></div></details>', 3)),
