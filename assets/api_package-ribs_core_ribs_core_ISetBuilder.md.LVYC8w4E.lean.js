...
const __pageData = JSON.parse('{"title":"ISetBuilder","description":"API documentation for ISetBuilder<A> class from ribs_core","frontmatter":{"title":"ISetBuilder<A>","description":"API documentation for ISetBuilder<A> class from ribs_core","category":"Classes","library":"ribs_core","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_core_ribs_core/ISetBuilder.md","filePath":"api/package-ribs_core_ribs_core/ISetBuilder.md"}');
const _sfc_main = { name: "api/package-ribs_core_ribs_core/ISetBuilder.md" };
const _hoisted_1 = {
  id: "isetbuilder-a",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("ISetBuilder<A> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#isetbuilder-a",
        "aria-label": 'Permalink to "ISetBuilder\\<A\\> <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
...
const ISetBuilder = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  ISetBuilder as default
};
