import { r as resolveComponent, o as openBlock, c as createElementBlock, a as createStaticVNode, b as createBaseVNode, d as createTextVNode, e as createVNode, _ as _export_sfc } from "./app.DwTP3cpl.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[12] || (_cache[12] = createStaticVNode('<h1 id="chunkbyteops" tabindex="-1">ChunkByteOps <a class="header-anchor" href="#chunkbyteops" aria-label="Permalink to &quot;ChunkByteOps&quot;">​</a></h1><div class="member-signature"><div class="member-signature-code" data-signature-normalized="true"><span class="member-signature-line"><span class="member-signature-token"><span class="kw">extension</span></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="fn">ChunkByteOps</span></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="kw">on</span></span><span class="member-signature-space"></span><span class="member-signature-token"><a href="./Chunk" class="type-link">Chunk</a></span><span class="member-signature-token">&lt;</span><span class="member-signature-token"><span class="type">int</span></span><span class="member-signature-token">&gt;</span></span></div></div><p>Byte-oriented operations for <a href="/ribs/api/package-ribs_rill_ribs_rill/Chunk.html">Chunk&lt;int&gt;</a>.</p><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 4)),
    ...
    _cache[14] || (_cache[14] = createStaticVNode('<div class="member-signature"><div class="member-signature-code" data-signature-normalized="true"><span class="member-signature-line"><span class="member-signature-token"><a href="../package-ribs_binary_ribs_binary/BitVector" class="type-link">BitVector</a></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="kw">get</span></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="fn">toBitVector</span></span></span></div></div><p>Interprets this byte chunk as a <a href="/ribs/api/package-ribs_binary_ribs_binary/BitVector.html">BitVector</a>.</p><p><em>Available on <a href="/ribs/api/package-ribs_rill_ribs_rill/Chunk.html">Chunk&lt;O&gt;</a>, provided by the <a href="/ribs/api/package-ribs_rill_ribs_rill/ChunkByteOps.html">ChunkByteOps</a> extension</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">BitVector</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toBitVector </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toByteVector.bits;</span></span></code></pre></div></details>', 4)),
    ...
    _cache[15] || (_cache[15] = createStaticVNode('<div class="member-signature"><div class="member-signature-code" data-signature-normalized="true"><span class="member-signature-line"><span class="member-signature-token"><a href="../package-ribs_binary_ribs_binary/ByteVector" class="type-link">ByteVector</a></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="kw">get</span></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="fn">toByteVector</span></span></span></div></div><p>Wraps this chunk as a zero-copy <a href="/ribs/api/package-ribs_binary_ribs_binary/ByteVector.html">ByteVector</a> view.</p><p><em>Available on <a href="/ribs/api/package-ribs_rill_ribs_rill/Chunk.html">Chunk&lt;O&gt;</a>, provided by the <a href="/ribs/api/package-ribs_rill_ribs_rill/ChunkByteOps.html">ChunkByteOps</a> extension</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">ByteVector</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toByteVector </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> ByteVector</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">viewAt</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">At</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">((i) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[i]), size);</span></span></code></pre></div></details>', 4))
  ]);
}
