...
const __pageData = JSON.parse('{"title":"RequestCookie","description":"API documentation for RequestCookie class from ribs_http","frontmatter":{"title":"RequestCookie","description":"API documentation for RequestCookie class from ribs_http","category":"Classes","library":"ribs_http","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_http_ribs_http/RequestCookie.md","filePath":"api/package-ribs_http_ribs_http/RequestCookie.md"}');
const _sfc_main = { name: "api/package-ribs_http_ribs_http/RequestCookie.md" };
const _hoisted_1 = {
  id: "requestcookie",
  tabindex: "-1"
};
const _hoisted_2 = {
  id: "ctor-requestcookie",
  tabindex: "-1"
};
const _hoisted_3 = {
  id: "prop-content",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("RequestCookie ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#requestcookie",
        "aria-label": 'Permalink to "RequestCookie <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
    _cache[29] || (_cache[29] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">RequestCookie</span></code></pre></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 2)),
    createBaseVNode("h3", _hoisted_2, [
      _cache[3] || (_cache[3] = createTextVNode("RequestCookie() ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "const"
      }),
      ...
      _cache[5] || (_cache[5] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#ctor-requestcookie",
        "aria-label": 'Permalink to "RequestCookie() <Badge type="tip" text="const" /> {#ctor-requestcookie}"'
      }, "​", -1))
    ]),
    _cache[30] || (_cache[30] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">const</span> <span class="fn">RequestCookie</span>(<span class="type">String</span> <span class="param">name</span>, <span class="type">String</span> <span class="param">content</span>)</code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> RequestCookie</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.name, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.content);</span></span></code></pre></div></details><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 3)),
    createBaseVNode("h3", _hoisted_3, [
      _cache[6] || (_cache[6] = createTextVNode("content ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
      ...
      _cache[8] || (_cache[8] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-content",
        "aria-label": 'Permalink to "content <Badge type="tip" text="final" /> {#prop-content}"'
      }, "​", -1))
    ]),
    _cache[31] || (_cache[31] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">String</span> <span class="fn">content</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> content;</span></span></code></pre></div></details>', 2)),
    ...
    _cache[33] || (_cache[33] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">String</span> <span class="fn">name</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> name;</span></span></code></pre></div></details>', 2)),
...
const RequestCookie = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  RequestCookie as default
};
