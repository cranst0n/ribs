...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[31] || (_cache[31] = createStaticVNode('<h1 id="realioruntime" tabindex="-1">RealIORuntime <a class="header-anchor" href="#realioruntime" aria-label="Permalink to &quot;RealIORuntime&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">RealIORuntime</span> <span class="kw">extends</span> <a href="./IORuntime" class="type-link">IORuntime</a></code></pre></div><p>The default <a href="/ribs/api/package-ribs_effect_ribs_effect/IORuntime.html">IORuntime</a> implementation backed by Dart&#39;s <a href="https://api.dart.dev/stable/3.11.4/dart-async/Timer-class.html" target="_blank" rel="noreferrer">Timer</a> API.</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_effect_ribs_effect/IORuntime.html">IORuntime</a> → <strong>RealIORuntime</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-realioruntime" tabindex="-1">RealIORuntime() <a class="header-anchor" href="#ctor-realioruntime" aria-label="Permalink to &quot;RealIORuntime() {#ctor-realioruntime}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">RealIORuntime</span>({<span class="type">int</span> <span class="param">autoCedeN</span> = DefaultAutoCedeN})</code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">RealIORuntime</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">super</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.autoCedeN});</span></span></code></pre></div></details><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 9)),
    ...
    _cache[34] || (_cache[34] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">DateTime</span> <span class="kw">get</span> <span class="fn">now</span></code></pre></div><p>Returns the current time.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@override</span></span>\n<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">DateTime</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> now </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> DateTime</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">now</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></details>', 3)),
