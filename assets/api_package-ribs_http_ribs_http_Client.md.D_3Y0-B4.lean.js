...
const __pageData = JSON.parse('{"title":"Client","description":"API documentation for Client class from ribs_http","frontmatter":{"title":"Client","description":"API documentation for Client class from ribs_http","category":"Classes","library":"ribs_http","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_http_ribs_http/Client.md","filePath":"api/package-ribs_http_ribs_http/Client.md"}');
const _sfc_main = { name: "api/package-ribs_http_ribs_http/Client.md" };
const _hoisted_1 = {
  id: "client",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Client ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#client",
        "aria-label": 'Permalink to "Client <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    ...
    _cache[22] || (_cache[22] = createStaticVNode("", 50)),
    ...
    _cache[23] || (_cache[23] = createStaticVNode("", 40)),
...
const Client = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Client as default
};
