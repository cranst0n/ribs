...
const __pageData = JSON.parse('{"title":"Celcius","description":"API documentation for Celcius class from ribs_units","frontmatter":{"title":"Celcius","description":"API documentation for Celcius class from ribs_units","category":"Classes","library":"ribs_units","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_units_ribs_units/Celcius.md","filePath":"api/package-ribs_units_ribs_units/Celcius.md"}');
const _sfc_main = { name: "api/package-ribs_units_ribs_units/Celcius.md" };
const _hoisted_1 = {
  id: "celcius",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Celcius ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#celcius",
        "aria-label": 'Permalink to "Celcius <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
    _cache[43] || (_cache[43] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">Celcius</span> <span class="kw">extends</span> <a href="./TemperatureScale" class="type-link">TemperatureScale</a></code></pre></div><p>The Celsius temperature scale (°C).</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_units_ribs_units/UnitOfMeasure.html">UnitOfMeasure&lt;A extends Quantity&lt;A&gt;&gt;</a> → <a href="/ribs/api/package-ribs_units_ribs_units/TemperatureScale.html">TemperatureScale</a> → <strong>Celcius</strong></p></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 4)),
...
const Celcius = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Celcius as default
};
