...
const __pageData = JSON.parse('{"title":"DatagramSocket","description":"API documentation for DatagramSocket class from ribs_rill_io","frontmatter":{"title":"DatagramSocket","description":"API documentation for DatagramSocket class from ribs_rill_io","category":"Classes","library":"ribs_rill_io","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_rill_io_ribs_rill_io/DatagramSocket.md","filePath":"api/package-ribs_rill_io_ribs_rill_io/DatagramSocket.md"}');
const _sfc_main = { name: "api/package-ribs_rill_io_ribs_rill_io/DatagramSocket.md" };
const _hoisted_1 = {
  id: "datagramsocket",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("DatagramSocket ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#datagramsocket",
        "aria-label": 'Permalink to "DatagramSocket <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    _cache[29] || (_cache[29] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">DatagramSocket</span></code></pre></div><p>A bound UDP socket for sending and receiving datagrams.</p><p>Unlike TCP <a href="/ribs/api/package-ribs_rill_io_ribs_rill_io/Socket.html">Socket</a>s, datagrams are connectionless — each <a href="/ribs/api/package-ribs_rill_io_ribs_rill_io/Datagram.html">Datagram</a> carries its own remote <a href="/ribs/api/package-ribs_ip_ribs_ip/SocketAddress.html">SocketAddress</a>, and messages are delivered as discrete packets rather than a continuous byte stream.</p><p>Obtain instances via <a href="/ribs/api/package-ribs_rill_io_ribs_rill_io/Network.html#binddatagramsocket">Network.bindDatagramSocket</a>, which returns a resource-managed socket that is automatically closed on release.</p><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-datagramsocket" tabindex="-1">DatagramSocket() <a class="header-anchor" href="#ctor-datagramsocket" aria-label="Permalink to &quot;DatagramSocket() {#ctor-datagramsocket}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">DatagramSocket</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 8)),
    createBaseVNode("h3", _hoisted_2, [
      ...
      _cache[5] || (_cache[5] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-address",
        "aria-label": 'Permalink to "address <Badge type="tip" text="no setter" /> {#prop-address}"'
      }, "​", -1))
    ]),
    _cache[30] || (_cache[30] = createStaticVNode('<div class="member-signature"><pre><code><a href="../package-ribs_ip_ribs_ip/SocketAddress" class="type-link">SocketAddress</a>&lt;<a href="../package-ribs_ip_ribs_ip/Host" class="type-link">Host</a>&gt; <span class="kw">get</span> <span class="fn">address</span></code></pre></div><p>The local address this socket is bound to.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">SocketAddress</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> address;</span></span></code></pre></div></details>', 3)),
    ...
    _cache[32] || (_cache[32] = createStaticVNode('<div class="member-signature"><pre><code><a href="../package-ribs_rill_ribs_rill/Rill" class="type-link">Rill</a>&lt;<a href="./Datagram" class="type-link">Datagram</a>&gt; <span class="kw">get</span> <span class="fn">reads</span></code></pre></div><p>A continuous stream of received datagrams. The <a href="/ribs/api/package-ribs_rill_ribs_rill/Rill.html">Rill</a> terminates when the socket is closed.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Rill</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Datagram</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> reads;</span></span></code></pre></div></details>', 3)),
    ...
    createBaseVNode("h3", _hoisted_6, [
      _cache[17] || (_cache[17] = createTextVNode("writes ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "no setter"
      }),
    ...
    _cache[34] || (_cache[34] = createStaticVNode('<div class="member-signature"><pre><code><a href="../package-ribs_rill_ribs_rill/Rill" class="type-link">Rill</a>&lt;<span class="type">Never</span>&gt; <span class="type">Function</span>(<a href="../package-ribs_rill_ribs_rill/Rill" class="type-link">Rill</a>&lt;<a href="./Datagram" class="type-link">Datagram</a>&gt;) <span class="kw">get</span> <span class="fn">writes</span></code></pre></div><p>A <a href="/ribs/api/package-ribs_rill_ribs_rill/Pipe.html">Pipe</a> that sends all incoming datagrams through this socket.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Pipe</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Datagram</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Never</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> writes;</span></span></code></pre></div></details><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2><h3 id="disconnect" tabindex="-1">disconnect() <a class="header-anchor" href="#disconnect" aria-label="Permalink to &quot;disconnect() {#disconnect}&quot;">​</a></h3><div class="member-signature"><pre><code><a href="../package-ribs_effect_ribs_effect/IO" class="type-link">IO</a>&lt;<a href="../package-ribs_core_ribs_core/Unit" class="type-link">Unit</a>&gt; <span class="fn">disconnect</span>()</code></pre></div><p>Disconnects the socket, removing any previously set default remote address.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">IO</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Unit</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">disconnect</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></details>', 8)),
    ...
    _cache[36] || (_cache[36] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">String</span> <span class="fn">toString</span>()</code></pre></div><p>A string representation of this object.</p><p>Some classes have a default textual representation, often paired with a static <code>parse</code> function (like <a href="https://api.dart.dev/stable/3.11.4/dart-core/int/parse.html" target="_blank" rel="noreferrer">int.parse</a>). These classes will provide the textual representation as their string representation.</p><p>Other classes have no meaningful textual representation that a program will care about. Such classes will typically override <code>toString</code> to provide useful information when inspecting the object, mainly for debugging or logging.</p><p><em>Inherited from Object.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">external</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> String</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> toString</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></details><h3 id="write" tabindex="-1">write() <a class="header-anchor" href="#write" aria-label="Permalink to &quot;write() {#write}&quot;">​</a></h3><div class="member-signature"><pre><code><a href="../package-ribs_effect_ribs_effect/IO" class="type-link">IO</a>&lt;<a href="../package-ribs_core_ribs_core/Unit" class="type-link">Unit</a>&gt; <span class="fn">write</span>(<a href="./Datagram" class="type-link">Datagram</a> <span class="param">datagram</span>)</code></pre></div><p>Sends <code>datagram</code> to the remote address specified within it.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">IO</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Unit</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">write</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Datagram</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> datagram);</span></span></code></pre></div></details><h2 id="section-operators" tabindex="-1">Operators <a class="header-anchor" href="#section-operators" aria-label="Permalink to &quot;Operators {#section-operators}&quot;">​</a></h2>', 11)),
...
const DatagramSocket = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  DatagramSocket as default
};
