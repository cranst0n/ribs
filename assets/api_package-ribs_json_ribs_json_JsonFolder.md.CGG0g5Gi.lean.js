...
const __pageData = JSON.parse('{"title":"JsonFolder","description":"API documentation for JsonFolder<A> class from ribs_json","frontmatter":{"title":"JsonFolder<A>","description":"API documentation for JsonFolder<A> class from ribs_json","category":"Classes","library":"ribs_json","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_json_ribs_json/JsonFolder.md","filePath":"api/package-ribs_json_ribs_json/JsonFolder.md"}');
const _sfc_main = { name: "api/package-ribs_json_ribs_json/JsonFolder.md" };
const _hoisted_1 = {
  id: "jsonfolder-a",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("JsonFolder<A> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#jsonfolder-a",
        "aria-label": 'Permalink to "JsonFolder\\<A\\> <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    ...
    _cache[23] || (_cache[23] = createStaticVNode("", 31)),
...
const JsonFolder = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  JsonFolder as default
};
