...
const __pageData = JSON.parse('{"title":"Supervisor","description":"API documentation for Supervisor class from ribs_effect","frontmatter":{"title":"Supervisor","description":"API documentation for Supervisor class from ribs_effect","category":"Classes","library":"ribs_effect","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_effect_ribs_effect/Supervisor.md","filePath":"api/package-ribs_effect_ribs_effect/Supervisor.md"}');
const _sfc_main = { name: "api/package-ribs_effect_ribs_effect/Supervisor.md" };
const _hoisted_1 = {
  id: "supervisor",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Supervisor ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#supervisor",
        "aria-label": 'Permalink to "Supervisor <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
...
const Supervisor = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
