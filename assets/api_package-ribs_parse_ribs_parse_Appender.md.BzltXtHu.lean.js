...
const __pageData = JSON.parse('{"title":"Appender<A, B>","description":"API documentation for Appender<A, B> class from ribs_parse","frontmatter":{"title":"Appender<A, B>","description":"API documentation for Appender<A, B> class from ribs_parse","category":"Classes","library":"ribs_parse","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_parse_ribs_parse/Appender.md","filePath":"api/package-ribs_parse_ribs_parse/Appender.md"}');
const _sfc_main = { name: "api/package-ribs_parse_ribs_parse/Appender.md" };
const _hoisted_1 = {
  id: "appender-a-b",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Appender<A, B> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#appender-a-b",
        "aria-label": 'Permalink to "Appender\\<A, B\\> <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    ...
    _cache[25] || (_cache[25] = createStaticVNode("", 26))
  ]);
}
const Appender = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Appender as default
};
