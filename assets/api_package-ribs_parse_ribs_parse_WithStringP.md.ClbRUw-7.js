...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[151] || (_cache[151] = createStaticVNode('<div class="member-signature"><pre><code><a href="./With1" class="type-link">With1</a>&lt;<span class="type">Record</span>&gt; <span class="kw">get</span> <span class="fn">with1</span></code></pre></div><p>Promotes this <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser0.html">Parser0</a> so it can be sequenced with a <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser.html">Parser</a> to produce a <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser.html">Parser</a> result.</p><p>All combinators on <a href="/ribs/api/package-ribs_parse_ribs_parse/With1.html">With1</a> return <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser.html">Parser</a> instead of <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser0.html">Parser0</a>, which is useful when at least one side of a product is known to consume input.</p><p><em>Inherited from Parser0.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">With1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> with1 </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> With1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span></code></pre></div></details>', 5)),
