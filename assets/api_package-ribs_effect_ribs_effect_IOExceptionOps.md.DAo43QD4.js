...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createStaticVNode('<h1 id="ioexceptionops-a" tabindex="-1">IOExceptionOps&lt;A&gt; <a class="header-anchor" href="#ioexceptionops-a" aria-label="Permalink to &quot;IOExceptionOps\\&lt;A\\&gt;&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">extension</span> <span class="fn">IOExceptionOps</span>&lt;A&gt; <span class="kw">on</span> <a href="./IO" class="type-link">IO</a>&lt;<a href="../package-ribs_core_ribs_core/Either" class="type-link">Either</a>&lt;<span class="type">Object</span>, <span class="type">A</span>&gt;&gt;</code></pre></div><p>Extension providing operations for unpacking <a href="../package-ribs_core_ribs_core/Either.html" class="api-link"><code>Either</code></a> typed IOs.</p><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
