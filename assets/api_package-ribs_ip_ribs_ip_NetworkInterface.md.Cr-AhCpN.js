...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[26] || (_cache[26] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">NetworkInterface</span></code></pre></div><p>A network interface — a named hardware or virtual adapter with one or more IP addresses expressed as CIDR blocks.</p><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-networkinterface" tabindex="-1">NetworkInterface() <a class="header-anchor" href="#ctor-networkinterface" aria-label="Permalink to &quot;NetworkInterface() {#ctor-networkinterface}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">NetworkInterface</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 6)),
    ...
    _cache[27] || (_cache[27] = createStaticVNode('<div class="member-signature"><pre><code><a href="../package-ribs_core_ribs_core/IList" class="type-link">IList</a>&lt;<a href="./Cidr" class="type-link">Cidr</a>&lt;<a href="./IpAddress" class="type-link">IpAddress</a>&gt;&gt; <span class="kw">get</span> <span class="fn">addresses</span></code></pre></div><p>The IP addresses assigned to this interface, each paired with its subnet prefix length as a <a href="./Cidr.html" class="api-link"><code>Cidr</code></a>.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">IList</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Cidr</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">IpAddress</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;&gt; </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> addresses;</span></span></code></pre></div></details>', 3)),
