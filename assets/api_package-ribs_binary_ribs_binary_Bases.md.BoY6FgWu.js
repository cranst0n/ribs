...
const __pageData = JSON.parse('{"title":"Bases","description":"API documentation for Bases class from ribs_binary","frontmatter":{"title":"Bases","description":"API documentation for Bases class from ribs_binary","category":"Classes","library":"ribs_binary","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_binary_ribs_binary/Bases.md","filePath":"api/package-ribs_binary_ribs_binary/Bases.md"}');
const _sfc_main = { name: "api/package-ribs_binary_ribs_binary/Bases.md" };
const _hoisted_1 = {
  id: "bases",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Bases ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#bases",
        "aria-label": 'Permalink to "Bases <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    _cache[20] || (_cache[20] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">Bases</span></code></pre></div><p>Constants used by <a href="/ribs/api/package-ribs_binary_ribs_binary/Alphabet.html">Alphabet</a> implementations to signal special handling of characters during base decoding.</p><p>These sentinel values are returned from <a href="/ribs/api/package-ribs_binary_ribs_binary/Alphabet.html#toindex">Alphabet.toIndex</a> to communicate that a character does not map to a value in the alphabet but should be handled in a specific way rather than throwing an error.</p><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-bases" tabindex="-1">Bases() <a class="header-anchor" href="#ctor-bases" aria-label="Permalink to &quot;Bases() {#ctor-bases}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">Bases</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 7)),
    ...
    _cache[25] || (_cache[25] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">bool</span> <span class="fn">operator ==</span>(<span class="type">Object</span> <span class="param">other</span>)</code></pre></div><p>The equality operator.</p><p>The default behavior for all <a href="https://api.dart.dev/stable/3.11.4/dart-core/Object-class.html" target="_blank" rel="noreferrer">Object</a>s is to return true if and only if this object and <code>other</code> are the same object.</p><p>Override this method to specify a different equality relation on a class. The overriding method must still be an equivalence relation. That is, it must be:</p><ul><li><p>Total: It must return a boolean for all arguments. It should never throw.</p></li><li><p>Reflexive: For all objects <code>o</code>, <code>o == o</code> must be true.</p></li><li><p>Symmetric: For all objects <code>o1</code> and <code>o2</code>, <code>o1 == o2</code> and <code>o2 == o1</code> must either both be true, or both be false.</p></li><li><p>Transitive: For all objects <code>o1</code>, <code>o2</code>, and <code>o3</code>, if <code>o1 == o2</code> and <code>o2 == o3</code> are true, then <code>o1 == o3</code> must be true.</p></li></ul><p>The method should also be consistent over time, so whether two objects are equal should only change if at least one of the objects was modified.</p><p>If a subclass overrides the equality operator, it should override the <a href="https://api.dart.dev/stable/3.11.4/dart-core/Object/hashCode.html" target="_blank" rel="noreferrer">hashCode</a> method as well to maintain consistency.</p><p><em>Inherited from Object.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">external</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> bool</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> operator</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> ==</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Object</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> other);</span></span></code></pre></div></details><h2 id="section-constants" tabindex="-1">Constants <a class="header-anchor" href="#section-constants" aria-label="Permalink to &quot;Constants {#section-constants}&quot;">​</a></h2><h3 id="prop-ignorechar" tabindex="-1">IgnoreChar <a class="header-anchor" href="#prop-ignorechar" aria-label="Permalink to &quot;IgnoreChar {#prop-ignorechar}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="kw">const</span> <span class="type">int</span> <span class="fn">IgnoreChar</span></code></pre></div><p>Sentinel value returned from <a href="/ribs/api/package-ribs_binary_ribs_binary/Alphabet.html#toindex">Alphabet.toIndex</a> indicating that the character should be silently ignored during decoding.</p><p>Characters such as whitespace or visual separators (e.g. <code>_</code>, <code>-</code>) are commonly mapped to this value.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> IgnoreChar</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> -</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre></div></details><h3 id="prop-ignorerestofline" tabindex="-1">IgnoreRestOfLine <a class="header-anchor" href="#prop-ignorerestofline" aria-label="Permalink to &quot;IgnoreRestOfLine {#prop-ignorerestofline}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="kw">const</span> <span class="type">int</span> <span class="fn">IgnoreRestOfLine</span></code></pre></div><p>Sentinel value returned from <a href="/ribs/api/package-ribs_binary_ribs_binary/Alphabet.html#toindex">Alphabet.toIndex</a> indicating that the character and the remainder of the line should be ignored during decoding.</p><p>This is used for comment characters (e.g. <code>#</code>, <code>;</code>, <code>|</code>) in hex and binary string formats.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> IgnoreRestOfLine</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> -</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">2</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre></div></details>', 20))
  ]);
}
const Bases = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Bases as default
};
