...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[27] || (_cache[27] = createStaticVNode('<h1 id="watchermovedevent" tabindex="-1">WatcherMovedEvent <a class="header-anchor" href="#watchermovedevent" aria-label="Permalink to &quot;WatcherMovedEvent&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">WatcherMovedEvent</span> <span class="kw">extends</span> <a href="./WatcherEvent" class="type-link">WatcherEvent</a></code></pre></div><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/api/package-ribs_rill_io_ribs_rill_io/WatcherEvent.html">WatcherEvent</a> → <strong>WatcherMovedEvent</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 4)),
