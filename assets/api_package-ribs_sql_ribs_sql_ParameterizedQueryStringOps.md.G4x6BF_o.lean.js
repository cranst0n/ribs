...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("h3", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("parameterizedQuery() ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#parameterizedquery",
        "aria-label": 'Permalink to "parameterizedQuery() <Badge type="info" text="extension" /> {#parameterizedquery}"'
      }, "​", -1))
    ]),
