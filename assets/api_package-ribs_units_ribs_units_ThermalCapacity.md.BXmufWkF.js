...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[64] || (_cache[64] = createStaticVNode('<div class="member-signature"><pre><code><a href="./ThermalCapacity" class="type-link">ThermalCapacity</a> <span class="kw">get</span> <span class="fn">toBtuPerFahrenheit</span></code></pre></div><p>Converts this to BTU per degree Fahrenheit (BTU/°F).</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">ThermalCapacity</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toBtuPerFahrenheit </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> to</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(btuPerFahrenheit).btuPerFahrenheit;</span></span></code></pre></div></details>', 3)),
    ...
    _cache[65] || (_cache[65] = createStaticVNode('<div class="member-signature"><pre><code><a href="./ThermalCapacity" class="type-link">ThermalCapacity</a> <span class="kw">get</span> <span class="fn">toJoulesPerKelvin</span></code></pre></div><p>Converts this to joules per kelvin (J/K).</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">ThermalCapacity</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toJoulesPerKelvin </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> to</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(joulesPerKelvin).joulesPerKelvin;</span></span></code></pre></div></details>', 3)),
