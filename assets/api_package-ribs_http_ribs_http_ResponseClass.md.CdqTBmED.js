...
const __pageData = JSON.parse('{"title":"ResponseClass","description":"API documentation for ResponseClass enum from ribs_http","frontmatter":{"title":"ResponseClass","description":"API documentation for ResponseClass enum from ribs_http","category":"Enums","library":"ribs_http","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_http_ribs_http/ResponseClass.md","filePath":"api/package-ribs_http_ribs_http/ResponseClass.md"}');
const _sfc_main = { name: "api/package-ribs_http_ribs_http/ResponseClass.md" };
const _hoisted_1 = {
  id: "prop-hashcode",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[28] || (_cache[28] = createStaticVNode('<h1 id="responseclass" tabindex="-1">ResponseClass <a class="header-anchor" href="#responseclass" aria-label="Permalink to &quot;ResponseClass&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">enum</span> <span class="fn">ResponseClass</span></code></pre></div><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → Enum → <strong>ResponseClass</strong></p></div><div class="info custom-block"><p class="custom-block-title">Available Extensions</p><ul><li>EnumName</li></ul></div><h2 id="section-values" tabindex="-1">Values <a class="header-anchor" href="#section-values" aria-label="Permalink to &quot;Values {#section-values}&quot;">​</a></h2><h3 id="value-informational" tabindex="-1">informational <a class="header-anchor" href="#value-informational" aria-label="Permalink to &quot;informational {#value-informational}&quot;">​</a></h3><h3 id="value-successful" tabindex="-1">successful <a class="header-anchor" href="#value-successful" aria-label="Permalink to &quot;successful {#value-successful}&quot;">​</a></h3><h3 id="value-redirection" tabindex="-1">redirection <a class="header-anchor" href="#value-redirection" aria-label="Permalink to &quot;redirection {#value-redirection}&quot;">​</a></h3><h3 id="value-clienterror" tabindex="-1">clientError <a class="header-anchor" href="#value-clienterror" aria-label="Permalink to &quot;clientError {#value-clienterror}&quot;">​</a></h3><h3 id="value-servererror" tabindex="-1">serverError <a class="header-anchor" href="#value-servererror" aria-label="Permalink to &quot;serverError {#value-servererror}&quot;">​</a></h3><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 11)),
    ...
    _cache[30] || (_cache[30] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">int</span> <span class="kw">get</span> <span class="fn">index</span></code></pre></div><p>The integer index of this enum value.</p><p><em>Inherited from Enum.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">int</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> index;</span></span></code></pre></div></details>', 4)),
    createBaseVNode("h3", _hoisted_3, [
      _cache[8] || (_cache[8] = createTextVNode("isSuccess ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
      ...
      _cache[10] || (_cache[10] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-issuccess",
        "aria-label": 'Permalink to "isSuccess <Badge type="tip" text="final" /> {#prop-issuccess}"'
      }, "​", -1))
    ]),
    _cache[31] || (_cache[31] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">bool</span> <span class="fn">isSuccess</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> bool</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> isSuccess;</span></span></code></pre></div></details>', 2)),
    ...
    createBaseVNode("h3", _hoisted_5, [
      _cache[15] || (_cache[15] = createTextVNode("name ", -1)),
      createVNode(_component_Badge, {
        type: "info",
        text: "extension"
      }),
