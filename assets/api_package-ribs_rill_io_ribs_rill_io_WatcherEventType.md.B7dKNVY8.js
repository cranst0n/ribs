...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[25] || (_cache[25] = createStaticVNode('<h1 id="watchereventtype" tabindex="-1">WatcherEventType <a class="header-anchor" href="#watchereventtype" aria-label="Permalink to &quot;WatcherEventType&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">enum</span> <span class="fn">WatcherEventType</span></code></pre></div><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → Enum → <strong>WatcherEventType</strong></p></div><div class="info custom-block"><p class="custom-block-title">Available Extensions</p><ul><li>EnumName</li></ul></div><h2 id="section-values" tabindex="-1">Values <a class="header-anchor" href="#section-values" aria-label="Permalink to &quot;Values {#section-values}&quot;">​</a></h2><h3 id="value-created" tabindex="-1">created <a class="header-anchor" href="#value-created" aria-label="Permalink to &quot;created {#value-created}&quot;">​</a></h3><h3 id="value-deleted" tabindex="-1">deleted <a class="header-anchor" href="#value-deleted" aria-label="Permalink to &quot;deleted {#value-deleted}&quot;">​</a></h3><h3 id="value-modified" tabindex="-1">modified <a class="header-anchor" href="#value-modified" aria-label="Permalink to &quot;modified {#value-modified}&quot;">​</a></h3><h3 id="value-moved" tabindex="-1">moved <a class="header-anchor" href="#value-moved" aria-label="Permalink to &quot;moved {#value-moved}&quot;">​</a></h3><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 10)),
