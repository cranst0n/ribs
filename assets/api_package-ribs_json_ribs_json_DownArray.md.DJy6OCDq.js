...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[28] || (_cache[28] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">DownArray</span> <span class="kw">extends</span> <span class="type">_ArrayOp</span></code></pre></div><p>Cursor descended into the first element of a JSON array.</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_json_ribs_json/CursorOp.html">CursorOp</a> → <strong>DownArray</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-downarray" tabindex="-1">DownArray() <a class="header-anchor" href="#ctor-downarray" aria-label="Permalink to &quot;DownArray() {#ctor-downarray}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">DownArray</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 7)),
