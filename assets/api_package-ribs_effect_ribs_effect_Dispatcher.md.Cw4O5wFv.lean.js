...
const __pageData = JSON.parse('{"title":"Dispatcher","description":"API documentation for Dispatcher class from ribs_effect","frontmatter":{"title":"Dispatcher","description":"API documentation for Dispatcher class from ribs_effect","category":"Classes","library":"ribs_effect","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_effect_ribs_effect/Dispatcher.md","filePath":"api/package-ribs_effect_ribs_effect/Dispatcher.md"}');
const _sfc_main = { name: "api/package-ribs_effect_ribs_effect/Dispatcher.md" };
const _hoisted_1 = {
  id: "dispatcher",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Dispatcher ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#dispatcher",
        "aria-label": 'Permalink to "Dispatcher <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    _cache[20] || (_cache[20] = createStaticVNode("", 9)),
    ...
    _cache[24] || (_cache[24] = createStaticVNode("", 23)),
...
const Dispatcher = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
