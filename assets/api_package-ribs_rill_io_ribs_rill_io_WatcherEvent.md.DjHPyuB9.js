...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[23] || (_cache[23] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">sealed</span> <span class="kw">class</span> <span class="fn">WatcherEvent</span></code></pre></div><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/api/package-ribs_rill_io_ribs_rill_io/WatcherCreatedEvent.html">WatcherCreatedEvent</a></li><li><a href="/api/package-ribs_rill_io_ribs_rill_io/WatcherDeletedEvent.html">WatcherDeletedEvent</a></li><li><a href="/api/package-ribs_rill_io_ribs_rill_io/WatcherModifiedEvent.html">WatcherModifiedEvent</a></li><li><a href="/api/package-ribs_rill_io_ribs_rill_io/WatcherMovedEvent.html">WatcherMovedEvent</a></li></ul></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 3)),
