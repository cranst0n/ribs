...
const __pageData = JSON.parse('{"title":"SyncIO","description":"API documentation for SyncIO<A> class from ribs_effect","frontmatter":{"title":"SyncIO<A>","description":"API documentation for SyncIO<A> class from ribs_effect","category":"Classes","library":"ribs_effect","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_effect_ribs_effect/SyncIO.md","filePath":"api/package-ribs_effect_ribs_effect/SyncIO.md"}');
const _sfc_main = { name: "api/package-ribs_effect_ribs_effect/SyncIO.md" };
const _hoisted_1 = {
  id: "syncio-a",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("SyncIO<A> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#syncio-a",
        "aria-label": 'Permalink to "SyncIO\\<A\\> <Badge type="info" text="sealed" />"'
      }, "​", -1))
    ]),
    ...
    _cache[35] || (_cache[35] = createStaticVNode("", 28)),
...
const SyncIO = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  SyncIO as default
};
