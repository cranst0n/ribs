...
const __pageData = JSON.parse('{"title":"DecodeFailure","description":"API documentation for DecodeFailure class from ribs_http","frontmatter":{"title":"DecodeFailure","description":"API documentation for DecodeFailure class from ribs_http","category":"Exceptions","library":"ribs_http","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_http_ribs_http/DecodeFailure.md","filePath":"api/package-ribs_http_ribs_http/DecodeFailure.md"}');
const _sfc_main = { name: "api/package-ribs_http_ribs_http/DecodeFailure.md" };
const _hoisted_1 = {
  id: "prop-hashcode",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[23] || (_cache[23] = createStaticVNode('<h1 id="decodefailure" tabindex="-1">DecodeFailure <a class="header-anchor" href="#decodefailure" aria-label="Permalink to &quot;DecodeFailure&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">DecodeFailure</span> <span class="kw">implements</span> <span class="type">Exception</span></code></pre></div><div class="info custom-block"><p class="custom-block-title">Implemented types</p><ul><li>Exception</li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-decodefailure" tabindex="-1">DecodeFailure() <a class="header-anchor" href="#ctor-decodefailure" aria-label="Permalink to &quot;DecodeFailure() {#ctor-decodefailure}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">DecodeFailure</span>(<span class="type">Object</span> <span class="param">message</span>, [<span class="type">StackTrace</span>? <span class="param">stackTrace</span>])</code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">DecodeFailure</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.message, [</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">StackTrace</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">?</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> stackTrace])</span></span>\n<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">  :</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> stackTrace </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> stackTrace </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">??</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> StackTrace</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.current;</span></span></code></pre></div></details><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 8)),
    ...
    _cache[25] || (_cache[25] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">Object</span> <span class="fn">message</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Object</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> message;</span></span></code></pre></div></details>', 2)),
    ...
    createBaseVNode("h3", _hoisted_4, [
      _cache[11] || (_cache[11] = createTextVNode("stackTrace ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
    ...
    _cache[27] || (_cache[27] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">StackTrace</span> <span class="fn">stackTrace</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> StackTrace</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> stackTrace;</span></span></code></pre></div></details><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 3)),
...
const DecodeFailure = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  DecodeFailure as default
};
