...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[26] || (_cache[26] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">Fn0</span>&lt;A&gt;</code></pre></div><p>Nominal wrappers around Dart function types.</p><p>Dart function types and class types have different variance rules, and this difference matters when building an interpreted ADT like <a href="../package-ribs_effect_ribs_effect/IO.html" class="api-link"><code>IO</code></a>.</p><p>Dart function types follow standard function subtyping: they are contravariant in their parameter types and covariant in their return type. <code>String Function(Object)</code> is a subtype of <code>String Function(String)</code>, because a function that accepts any <code>Object</code> can safely stand in for one that only accepts <code>String</code>.</p><p>This means that Dart enforces function signatures at runtime on casts. If you store a <code>String Function(String)</code> as <code>Object</code> and later try to cast it to <code>dynamic Function(dynamic)</code>, Dart will throw a <code>CastError</code> because the two types are not in a subtype relationship in the parameter position.</p><p>Class instances in Dart carry only their erased type at runtime. A cast <code>value as Fn1</code> checks only &quot;is this an instance of <a href="./Fn1.html" class="api-link"><code>Fn1</code></a>?&quot; — it does not check the type arguments <code>A</code> or <code>B</code>. The cast succeeds regardless of the concrete types stored in those parameters, yielding a <a href="./Fn1.html" class="api-link"><code>Fn1&lt;dynamic, dynamic&gt;</code></a>. Calling the result then invokes the underlying function, which performs its own checked cast internally.</p><p>In short, <code>Fn0</code>, <a href="./Fn1.html" class="api-link"><code>Fn1</code></a>, and <a href="./Fn2.html" class="api-link"><code>Fn2</code></a> exist to give functions class-like variance behaviour so they can live safely in a heterogeneous, type-erased collection without violating Dart&#39;s runtime type system. A nominal wrapper around a zero-argument function <code>() -&gt; A</code>.</p><p>See the file-level documentation for the motivation behind these wrappers.</p><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 9)),
    ...
    _cache[27] || (_cache[27] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">const</span> <span class="fn">Fn0</span>(<span class="type">A</span> <span class="type">Function</span>() <span class="param">f</span>)</code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Fn0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.f);</span></span></code></pre></div></details><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 3)),
    ...
    _cache[28] || (_cache[28] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">A</span> <span class="type">Function</span>() <span class="fn">f</span></code></pre></div><p>The underlying function.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Function0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; f;</span></span></code></pre></div></details>', 3)),
    ...
    _cache[30] || (_cache[30] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">Type</span> <span class="kw">get</span> <span class="fn">runtimeType</span></code></pre></div><p>A representation of the runtime type of the object.</p><p><em>Inherited from Object.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">external</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Type</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> runtimeType;</span></span></code></pre></div></details><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2><h3 id="call" tabindex="-1">call() <a class="header-anchor" href="#call" aria-label="Permalink to &quot;call() {#call}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="type">A</span> <span class="fn">call</span>()</code></pre></div><p>Invokes the underlying function and returns its result.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> call</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">() </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> f</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></details>', 9)),
