...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[28] || (_cache[28] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">DeleteGoParent</span> <span class="kw">extends</span> <span class="type">_UnconstrainedOp</span></code></pre></div><p>The focused value was deleted and the cursor moved to the parent.</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_json_ribs_json/CursorOp.html">CursorOp</a> → <strong>DeleteGoParent</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-deletegoparent" tabindex="-1">DeleteGoParent() <a class="header-anchor" href="#ctor-deletegoparent" aria-label="Permalink to &quot;DeleteGoParent() {#ctor-deletegoparent}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">DeleteGoParent</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 7)),
    ...
    _cache[30] || (_cache[30] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">bool</span> <span class="fn">requiresArray</span></code></pre></div><p>Whether this operation requires the cursor to be on a JSON array.</p><p><em>Inherited from CursorOp.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> bool</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> requiresArray;</span></span></code></pre></div></details>', 4)),
    ...
    _cache[31] || (_cache[31] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">bool</span> <span class="fn">requiresObject</span></code></pre></div><p>Whether this operation requires the cursor to be on a JSON object.</p><p><em>Inherited from CursorOp.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> bool</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> requiresObject;</span></span></code></pre></div></details>', 4)),
