...
const __pageData = JSON.parse('{"title":"Header","description":"API documentation for Header class from ribs_http","frontmatter":{"title":"Header","description":"API documentation for Header class from ribs_http","category":"Classes","library":"ribs_http","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_http_ribs_http/Header.md","filePath":"api/package-ribs_http_ribs_http/Header.md"}');
const _sfc_main = { name: "api/package-ribs_http_ribs_http/Header.md" };
const _hoisted_1 = {
  id: "header",
  tabindex: "-1"
};
...
const _hoisted_12 = {
  id: "prop-cachecontrol",
  tabindex: "-1"
};
const _hoisted_13 = {
  id: "prop-contentencoding",
  tabindex: "-1"
};
const _hoisted_14 = {
  id: "prop-contenttype",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Header ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#header",
        "aria-label": 'Permalink to "Header <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
    _cache[50] || (_cache[50] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">Header</span></code></pre></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 2)),
    createBaseVNode("h3", _hoisted_2, [
      _cache[3] || (_cache[3] = createTextVNode("Header() ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "const"
      }),
      ...
      _cache[5] || (_cache[5] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#ctor-header",
        "aria-label": 'Permalink to "Header() <Badge type="tip" text="const" /> {#ctor-header}"'
      }, "​", -1))
    ]),
    _cache[51] || (_cache[51] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">const</span> <span class="fn">Header</span>(<a href="./CIString" class="type-link">CIString</a> <span class="param">name</span>, <span class="type">String</span> <span class="param">value</span>)</code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Header</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.name, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.value);</span></span></code></pre></div></details><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 3)),
    ...
    _cache[53] || (_cache[53] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./CIString" class="type-link">CIString</a> <span class="fn">name</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> CIString</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> name;</span></span></code></pre></div></details>', 2)),
    ...
    _cache[55] || (_cache[55] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">String</span> <span class="fn">value</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> value;</span></span></code></pre></div></details><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 3)),
    ...
    createBaseVNode("h3", _hoisted_10, [
      ...
      _cache[31] || (_cache[31] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-accept",
        "aria-label": 'Permalink to "accept <Badge type="tip" text="final" /> {#prop-accept}"'
      }, "​", -1))
    ]),
    _cache[59] || (_cache[59] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./Header" class="type-link">Header</a> <span class="type">Function</span>(<a href="./MediaType" class="type-link">MediaType</a> <span class="param">mediaType</span>) <span class="fn">accept</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> final</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> accept </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Accept</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">().call;</span></span></code></pre></div></details>', 2)),
    createBaseVNode("h3", _hoisted_11, [
      _cache[32] || (_cache[32] = createTextVNode("authorization ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
      ...
      _cache[34] || (_cache[34] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-authorization",
        "aria-label": 'Permalink to "authorization <Badge type="tip" text="final" /> {#prop-authorization}"'
      }, "​", -1))
    ]),
    _cache[60] || (_cache[60] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./Authorization" class="type-link">Authorization</a> <span class="fn">authorization</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> final</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> authorization </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Authorization</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></details>', 2)),
    createBaseVNode("h3", _hoisted_12, [
      _cache[35] || (_cache[35] = createTextVNode("cacheControl ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
      ...
      _cache[37] || (_cache[37] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-cachecontrol",
        "aria-label": 'Permalink to "cacheControl <Badge type="tip" text="final" /> {#prop-cachecontrol}"'
      }, "​", -1))
    ]),
    _cache[61] || (_cache[61] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./Header" class="type-link">Header</a> <span class="type">Function</span>(<a href="./CacheDirective" class="type-link">CacheDirective</a> <span class="param">directiveA</span>, [<a href="./CacheDirective" class="type-link">CacheDirective</a>? <span class="param">directiveB</span>, <a href="./CacheDirective" class="type-link">CacheDirective</a>? <span class="param">directiveC</span>, <a href="./CacheDirective" class="type-link">CacheDirective</a>? <span class="param">directiveD</span>, <a href="./CacheDirective" class="type-link">CacheDirective</a>? <span class="param">directiveE</span>, <a href="./CacheDirective" class="type-link">CacheDirective</a>? <span class="param">directiveF</span>, <a href="./CacheDirective" class="type-link">CacheDirective</a>? <span class="param">directiveG</span>, <a href="./CacheDirective" class="type-link">CacheDirective</a>? <span class="param">directiveH</span>, <a href="./CacheDirective" class="type-link">CacheDirective</a>? <span class="param">directiveI</span>, <a href="./CacheDirective" class="type-link">CacheDirective</a>? <span class="param">directiveJ</span>]) <span class="fn">cacheControl</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> final</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> cacheControl </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> CacheControl</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">().call;</span></span></code></pre></div></details>', 2)),
    createBaseVNode("h3", _hoisted_13, [
      _cache[38] || (_cache[38] = createTextVNode("contentEncoding ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
      ...
      _cache[40] || (_cache[40] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-contentencoding",
        "aria-label": 'Permalink to "contentEncoding <Badge type="tip" text="final" /> {#prop-contentencoding}"'
      }, "​", -1))
    ]),
    _cache[62] || (_cache[62] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./Header" class="type-link">Header</a> <span class="type">Function</span>(<a href="./ContentCoding" class="type-link">ContentCoding</a> <span class="param">encoding</span>) <span class="fn">contentEncoding</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> final</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> contentEncoding </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> ContentEncoding</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">().call;</span></span></code></pre></div></details>', 2)),
    createBaseVNode("h3", _hoisted_14, [
      _cache[41] || (_cache[41] = createTextVNode("contentType ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
      ...
      _cache[43] || (_cache[43] = createBaseVNode("a", {
        ...
        "aria-label": 'Permalink to "contentType <Badge type="tip" text="final" /> {#prop-contenttype}"'
      }, "​", -1))
    ]),
    _cache[63] || (_cache[63] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./Header" class="type-link">Header</a> <span class="type">Function</span>(<a href="./ContentType" class="type-link">ContentType</a> <span class="param">contentType</span>) <span class="fn">contentType</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> final</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> contentType </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> ct.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">ContentType</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">().call;</span></span></code></pre></div></details>', 2)),
    createBaseVNode("h3", _hoisted_15, [
      _cache[44] || (_cache[44] = createTextVNode("cookie ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
      ...
      _cache[46] || (_cache[46] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-cookie",
        "aria-label": 'Permalink to "cookie <Badge type="tip" text="final" /> {#prop-cookie}"'
      }, "​", -1))
    ]),
    _cache[64] || (_cache[64] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./Header" class="type-link">Header</a> <span class="type">Function</span>(<a href="./RequestCookie" class="type-link">RequestCookie</a> <span class="param">cookieA</span>, [<a href="./RequestCookie" class="type-link">RequestCookie</a>? <span class="param">cookieB</span>, <a href="./RequestCookie" class="type-link">RequestCookie</a>? <span class="param">cookieC</span>, <a href="./RequestCookie" class="type-link">RequestCookie</a>? <span class="param">cookieD</span>, <a href="./RequestCookie" class="type-link">RequestCookie</a>? <span class="param">cookieE</span>, <a href="./RequestCookie" class="type-link">RequestCookie</a>? <span class="param">cookieF</span>, <a href="./RequestCookie" class="type-link">RequestCookie</a>? <span class="param">cookieG</span>, <a href="./RequestCookie" class="type-link">RequestCookie</a>? <span class="param">cookieH</span>, <a href="./RequestCookie" class="type-link">RequestCookie</a>? <span class="param">cookieI</span>, <a href="./RequestCookie" class="type-link">RequestCookie</a>? <span class="param">cookieJ</span>]) <span class="fn">cookie</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> final</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> cookie </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Cookie</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">().call;</span></span></code></pre></div></details>', 2)),
    createBaseVNode("h3", _hoisted_16, [
      _cache[47] || (_cache[47] = createTextVNode("set_cookie ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
      ...
      _cache[49] || (_cache[49] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-set_cookie",
        "aria-label": 'Permalink to "set_cookie <Badge type="tip" text="final" /> {#prop-set_cookie}"'
      }, "​", -1))
    ]),
    _cache[65] || (_cache[65] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./Header" class="type-link">Header</a> <span class="type">Function</span>(<a href="./RequestCookie" class="type-link">RequestCookie</a> <span class="param">head</span>) <span class="fn">set_cookie</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> final</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> set_cookie </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> SetCookie</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">().call;</span></span></code></pre></div></details>', 2))
  ]);
}
