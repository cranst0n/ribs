...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[38] || (_cache[38] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">HostnameLabel</span> <span class="kw">extends</span> <a href="../package-ribs_core_ribs_core/Ordered" class="type-link">Ordered</a>&lt;<a href="./HostnameLabel" class="type-link">HostnameLabel</a>&gt;</code></pre></div><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_core_ribs_core/Ordered.html">Ordered&lt;A&gt;</a> → <strong>HostnameLabel</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 3)),
