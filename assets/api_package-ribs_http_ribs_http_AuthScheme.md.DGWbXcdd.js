import { r as resolveComponent, o as openBlock, c as createElementBlock, a as createStaticVNode, b as createBaseVNode, d as createTextVNode, e as createVNode, _ as _export_sfc } from "./app.BEyiVJ70.js";
const __pageData = JSON.parse('{"title":"AuthScheme","description":"API documentation for AuthScheme enum from ribs_http","frontmatter":{"title":"AuthScheme","description":"API documentation for AuthScheme enum from ribs_http","category":"Enums","library":"ribs_http","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_http_ribs_http/AuthScheme.md","filePath":"api/package-ribs_http_ribs_http/AuthScheme.md"}');
const _sfc_main = { name: "api/package-ribs_http_ribs_http/AuthScheme.md" };
const _hoisted_1 = {
  id: "prop-hashcode",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[28] || (_cache[28] = createStaticVNode('<h1 id="authscheme" tabindex="-1">AuthScheme <a class="header-anchor" href="#authscheme" aria-label="Permalink to &quot;AuthScheme&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">enum</span> <span class="fn">AuthScheme</span></code></pre></div><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → Enum → <strong>AuthScheme</strong></p></div><div class="info custom-block"><p class="custom-block-title">Available Extensions</p><ul><li>EnumName</li></ul></div><h2 id="section-values" tabindex="-1">Values <a class="header-anchor" href="#section-values" aria-label="Permalink to &quot;Values {#section-values}&quot;">​</a></h2><h3 id="value-basic" tabindex="-1">basic <a class="header-anchor" href="#value-basic" aria-label="Permalink to &quot;basic {#value-basic}&quot;">​</a></h3><h3 id="value-bearer" tabindex="-1">bearer <a class="header-anchor" href="#value-bearer" aria-label="Permalink to &quot;bearer {#value-bearer}&quot;">​</a></h3><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 8)),
    ...
    createBaseVNode("h3", _hoisted_4, [
      _cache[12] || (_cache[12] = createTextVNode("value ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
    ...
    _cache[32] || (_cache[32] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./CIString" class="type-link">CIString</a> <span class="fn">value</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> CIString</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> value;</span></span></code></pre></div></details><h2 id="extension-section-properties" tabindex="-1">Extension Properties <a class="header-anchor" href="#extension-section-properties" aria-label="Permalink to &quot;Extension Properties {#extension-section-properties}&quot;">​</a></h2>', 3)),
