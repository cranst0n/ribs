...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createStaticVNode('<h1 id="validatednestedops-e-a" tabindex="-1">ValidatedNestedOps&lt;E, A&gt; <a class="header-anchor" href="#validatednestedops-e-a" aria-label="Permalink to &quot;ValidatedNestedOps\\&lt;E, A\\&gt;&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">extension</span> <span class="fn">ValidatedNestedOps</span>&lt;E, A&gt; <span class="kw">on</span> <a href="./Validated" class="type-link">Validated</a>&lt;<span class="type">E</span>, <a href="./Validated" class="type-link">Validated</a>&lt;<span class="type">E</span>, <span class="type">A</span>&gt;&gt;</code></pre></div><p>Operations available when a <a href="/ribs/api/package-ribs_core_ribs_core/Validated.html">Validated</a> contains another <a href="/ribs/api/package-ribs_core_ribs_core/Validated.html">Validated</a> as its valid value.</p><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
