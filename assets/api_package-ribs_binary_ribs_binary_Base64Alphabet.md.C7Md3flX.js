...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[36] || (_cache[36] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">Base64Alphabet</span> <span class="kw">extends</span> <a href="./PaddedAlphabet" class="type-link">PaddedAlphabet</a></code></pre></div><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_binary_ribs_binary/Alphabet.html">Alphabet</a> → <a href="/ribs/api/package-ribs_binary_ribs_binary/PaddedAlphabet.html">PaddedAlphabet</a> → <strong>Base64Alphabet</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 3)),
