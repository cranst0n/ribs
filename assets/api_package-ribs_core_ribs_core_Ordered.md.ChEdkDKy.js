...
const __pageData = JSON.parse('{"title":"Ordered","description":"API documentation for Ordered<A> class from ribs_core","frontmatter":{"title":"Ordered<A>","description":"API documentation for Ordered<A> class from ribs_core","category":"Classes","library":"ribs_core","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_core_ribs_core/Ordered.md","filePath":"api/package-ribs_core_ribs_core/Ordered.md"}');
const _sfc_main = { name: "api/package-ribs_core_ribs_core/Ordered.md" };
const _hoisted_1 = {
  id: "ordered-a",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Ordered<A> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#ordered-a",
        "aria-label": 'Permalink to "Ordered\\<A\\> <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    _cache[26] || (_cache[26] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">Ordered</span>&lt;A&gt; <span class="kw">implements</span> <span class="type">Comparable</span>&lt;<span class="type">A</span>&gt;</code></pre></div><p>Mixin that provides comparison operators for types that implement a total ordering via <a href="/ribs/api/package-ribs_core_ribs_core/Ordered.html#compareto">compareTo</a>.</p><p>Extend or implement this class to gain <code>&lt;</code>, <code>&lt;=</code>, <code>&gt;</code>, and <code>&gt;=</code> operators derived from <a href="/ribs/api/package-ribs_core_ribs_core/Ordered.html#compareto">compareTo</a>.</p><div class="info custom-block"><p class="custom-block-title">Implemented types</p><ul><li>Comparable&lt;T&gt;</li></ul></div><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/ribs/api/package-ribs_ip_ribs_ip/Host.html">Host</a></li><li><a href="/ribs/api/package-ribs_ip_ribs_ip/HostnameLabel.html">HostnameLabel</a></li><li><a href="/ribs/api/package-ribs_ip_ribs_ip/IDNLabel.html">IDNLabel</a></li><li><a href="/ribs/api/package-ribs_ip_ribs_ip/MacAddress.html">MacAddress</a></li><li><a href="/ribs/api/package-ribs_ip_ribs_ip/Port.html">Port</a></li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 6)),
    createBaseVNode("h3", _hoisted_2, [
      _cache[3] || (_cache[3] = createTextVNode("Ordered() ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "const"
      }),
      ...
      _cache[5] || (_cache[5] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#ctor-ordered",
        "aria-label": 'Permalink to "Ordered() <Badge type="tip" text="const" /> {#ctor-ordered}"'
      }, "​", -1))
    ]),
    _cache[27] || (_cache[27] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">const</span> <span class="fn">Ordered</span>()</code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Ordered</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></details><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 3)),
