import { r as resolveComponent, o as openBlock, c as createElementBlock, a as createBaseVNode, b as createTextVNode, d as createVNode, e as createStaticVNode, _ as _export_sfc } from "./app.08UaaYdG.js";
const __pageData = JSON.parse('{"title":"Fold<S, A>","description":"API documentation for Fold<S, A> class from ribs_optics","frontmatter":{"title":"Fold<S, A>","description":"API documentation for Fold<S, A> class from ribs_optics","category":"Classes","library":"ribs_optics","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_optics_ribs_optics/Fold.md","filePath":"api/package-ribs_optics_ribs_optics/Fold.md"}');
const _sfc_main = { name: "api/package-ribs_optics_ribs_optics/Fold.md" };
const _hoisted_1 = {
  id: "fold-s-a",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Fold<S, A> ", -1)),
      ...
      _cache[3] || (_cache[3] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#fold-s-a",
        "aria-label": 'Permalink to "Fold\\<S, A\\> <Badge type="info" text="abstract" /> <Badge type="info" text="mixin" />"'
      }, "​", -1))
    ]),
    _cache[21] || (_cache[21] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">mixin</span> <span class="kw">class</span> <span class="fn">Fold</span>&lt;S, A&gt;</code></pre></div><p>An optic that can find zero or more focus values of type <code>A</code> within a structure <code>S</code>.</p><p><a href="/ribs/api/package-ribs_optics_ribs_optics/Fold.html">Fold</a> is the most general read-only optic. It cannot modify the structure — use <a href="/ribs/api/package-ribs_optics_ribs_optics/Setter.html">Setter</a> or a more specific optic for that.</p><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/ribs/api/package-ribs_optics_ribs_optics/Getter.html">Getter&lt;S, A&gt;</a></li><li><a href="/ribs/api/package-ribs_optics_ribs_optics/PLens.html">PLens&lt;S, T, A, B&gt;</a></li><li><a href="/ribs/api/package-ribs_optics_ribs_optics/POptional.html">POptional&lt;S, T, A, B&gt;</a></li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-fold" tabindex="-1">Fold() <a class="header-anchor" href="#ctor-fold" aria-label="Permalink to &quot;Fold() {#ctor-fold}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">Fold</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 8)),
    ...
    _cache[23] || (_cache[23] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">Type</span> <span class="kw">get</span> <span class="fn">runtimeType</span></code></pre></div><p>A representation of the runtime type of the object.</p><p><em>Inherited from Object.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">external</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Type</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> runtimeType;</span></span></code></pre></div></details><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2><h3 id="exists" tabindex="-1">exists() <a class="header-anchor" href="#exists" aria-label="Permalink to &quot;exists() {#exists}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="type">bool</span> <span class="type">Function</span>(<span class="type">S</span>) <span class="fn">exists</span>(<span class="type">bool</span> <span class="type">Function</span>(<span class="type">A</span>) <span class="param">p</span>)</code></pre></div><p>Returns a predicate on <code>S</code> that is <code>true</code> when at least one focus satisfies <code>p</code>.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Function1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">S</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">bool</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">exists</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Function1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">bool</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; p) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (s) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> find</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(p)(s).isDefined;</span></span></code></pre></div></details><h3 id="find" tabindex="-1">find() <a class="header-anchor" href="#find" aria-label="Permalink to &quot;find() {#find}&quot;">​</a></h3><div class="member-signature"><pre><code><a href="../package-ribs_core_ribs_core/Option" class="type-link">Option</a>&lt;<span class="type">A</span>&gt; <span class="type">Function</span>(<span class="type">S</span>) <span class="fn">find</span>(<span class="type">bool</span> <span class="type">Function</span>(<span class="type">A</span>) <span class="param">p</span>)</code></pre></div><p>Returns a function that finds the first focus in <code>S</code> satisfying <code>p</code>, or <a href="/ribs/api/package-ribs_core_ribs_core/None.html">None</a> if no match exists.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Function1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">S</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Option</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">find</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Function1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">bool</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; p);</span></span></code></pre></div></details>', 13)),
