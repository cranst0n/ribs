...
const __pageData = JSON.parse('{"title":"Dns","description":"API documentation for Dns class from ribs_ip","frontmatter":{"title":"Dns","description":"API documentation for Dns class from ribs_ip","category":"Classes","library":"ribs_ip","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_ip_ribs_ip/Dns.md","filePath":"api/package-ribs_ip_ribs_ip/Dns.md"}');
const _sfc_main = { name: "api/package-ribs_ip_ribs_ip/Dns.md" };
const _hoisted_1 = {
  id: "dns",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Dns ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#dns",
        "aria-label": 'Permalink to "Dns <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
