...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[44] || (_cache[44] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">TemperatureScale</span> <span class="kw">extends</span> <a href="./UnitOfMeasure" class="type-link">UnitOfMeasure</a>&lt;<a href="./Temperature" class="type-link">Temperature</a>&gt;</code></pre></div><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/api/package-ribs_units_ribs_units/UnitOfMeasure.html">UnitOfMeasure&lt;A extends Quantity&lt;A&gt;&gt;</a> → <strong>TemperatureScale</strong></p></div><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/api/package-ribs_units_ribs_units/Celcius.html">Celcius</a></li><li><a href="/api/package-ribs_units_ribs_units/Fahrenheit.html">Fahrenheit</a></li><li><a href="/api/package-ribs_units_ribs_units/Kelvin.html">Kelvin</a></li><li><a href="/api/package-ribs_units_ribs_units/Rankine.html">Rankine</a></li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 4)),
