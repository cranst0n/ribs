...
const __pageData = JSON.parse('{"title":"UpdateReturning<A, B>","description":"API documentation for UpdateReturning<A, B> class from ribs_sql","frontmatter":{"title":"UpdateReturning<A, B>","description":"API documentation for UpdateReturning<A, B> class from ribs_sql","category":"Classes","library":"ribs_sql","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_sql_ribs_sql/UpdateReturning.md","filePath":"api/package-ribs_sql_ribs_sql/UpdateReturning.md"}');
const _sfc_main = { name: "api/package-ribs_sql_ribs_sql/UpdateReturning.md" };
const _hoisted_1 = {
  id: "updatereturning-a-b",
  tabindex: "-1"
};
const _hoisted_2 = {
  id: "ctor-updatereturning",
  tabindex: "-1"
};
const _hoisted_3 = {
  id: "prop-hashcode",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("UpdateReturning<A, B> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#updatereturning-a-b",
        "aria-label": 'Permalink to "UpdateReturning\\<A, B\\> <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
    _cache[32] || (_cache[32] = createStaticVNode("", 5)),
    createBaseVNode("h3", _hoisted_2, [
      _cache[3] || (_cache[3] = createTextVNode("UpdateReturning() ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "const"
      }),
      ...
      _cache[5] || (_cache[5] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#ctor-updatereturning",
        "aria-label": 'Permalink to "UpdateReturning() <Badge type="tip" text="const" /> {#ctor-updatereturning}"'
      }, "​", -1))
    ]),
    ...
    _cache[39] || (_cache[39] = createStaticVNode("", 21)),
...
const UpdateReturning = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  UpdateReturning as default
};
