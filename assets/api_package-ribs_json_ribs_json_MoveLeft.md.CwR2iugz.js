...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[28] || (_cache[28] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">MoveLeft</span> <span class="kw">extends</span> <span class="type">_UnconstrainedOp</span></code></pre></div><p>Cursor moved left to the previous array element.</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_json_ribs_json/CursorOp.html">CursorOp</a> → <strong>MoveLeft</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-moveleft" tabindex="-1">MoveLeft() <a class="header-anchor" href="#ctor-moveleft" aria-label="Permalink to &quot;MoveLeft() {#ctor-moveleft}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">MoveLeft</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 7)),
