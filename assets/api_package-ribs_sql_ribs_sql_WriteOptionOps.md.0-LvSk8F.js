...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createStaticVNode('<h1 id="writeoptionops-a" tabindex="-1">WriteOptionOps&lt;A&gt; <a class="header-anchor" href="#writeoptionops-a" aria-label="Permalink to &quot;WriteOptionOps\\&lt;A\\&gt;&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">extension</span> <span class="fn">WriteOptionOps</span>&lt;A&gt; <span class="kw">on</span> <a href="./Write" class="type-link">Write</a>&lt;<span class="type">A</span>&gt;</code></pre></div><p>Adds nullable column support to <a href="/ribs/api/package-ribs_sql_ribs_sql/Write.html">Write</a>.</p><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
