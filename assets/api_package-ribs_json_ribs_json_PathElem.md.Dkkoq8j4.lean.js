...
const __pageData = JSON.parse('{"title":"PathElem","description":"API documentation for PathElem class from ribs_json","frontmatter":{"title":"PathElem","description":"API documentation for PathElem class from ribs_json","category":"Classes","library":"ribs_json","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_json_ribs_json/PathElem.md","filePath":"api/package-ribs_json_ribs_json/PathElem.md"}');
const _sfc_main = { name: "api/package-ribs_json_ribs_json/PathElem.md" };
const _hoisted_1 = {
  id: "pathelem",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("PathElem ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#pathelem",
        "aria-label": 'Permalink to "PathElem <Badge type="info" text="sealed" />"'
      }, "​", -1))
    ]),
    ...
    _cache[25] || (_cache[25] = createStaticVNode("", 16))
  ]);
}
const PathElem = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  PathElem as default
};
