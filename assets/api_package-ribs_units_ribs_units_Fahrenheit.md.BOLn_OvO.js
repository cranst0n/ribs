...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[43] || (_cache[43] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">Fahrenheit</span> <span class="kw">extends</span> <a href="./TemperatureScale" class="type-link">TemperatureScale</a></code></pre></div><p>The Fahrenheit temperature scale (°F).</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_units_ribs_units/UnitOfMeasure.html">UnitOfMeasure&lt;A extends Quantity&lt;A&gt;&gt;</a> → <a href="/ribs/api/package-ribs_units_ribs_units/TemperatureScale.html">TemperatureScale</a> → <strong>Fahrenheit</strong></p></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 4)),
