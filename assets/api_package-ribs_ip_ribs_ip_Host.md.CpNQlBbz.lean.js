...
const __pageData = JSON.parse('{"title":"Host","description":"API documentation for Host class from ribs_ip","frontmatter":{"title":"Host","description":"API documentation for Host class from ribs_ip","category":"Classes","library":"ribs_ip","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_ip_ribs_ip/Host.md","filePath":"api/package-ribs_ip_ribs_ip/Host.md"}');
const _sfc_main = { name: "api/package-ribs_ip_ribs_ip/Host.md" };
const _hoisted_1 = {
  id: "host",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Host ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#host",
        "aria-label": 'Permalink to "Host <Badge type="info" text="sealed" />"'
      }, "​", -1))
    ]),
    ...
    createBaseVNode("h3", _hoisted_2, [
      ...
      _cache[5] || (_cache[5] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-ashost",
        "aria-label": 'Permalink to "asHost <Badge type="tip" text="no setter" /> {#prop-ashost}"'
      }, "​", -1))
    ]),
    ...
    createBaseVNode("h3", _hoisted_13, [
      _cache[38] || (_cache[38] = createTextVNode("order ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
      ...
      _cache[40] || (_cache[40] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-order",
        "aria-label": 'Permalink to "order <Badge type="tip" text="final" /> {#prop-order}"'
      }, "​", -1))
    ]),
    _cache[53] || (_cache[53] = createStaticVNode("", 8))
  ]);
}
const Host = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Host as default
};
