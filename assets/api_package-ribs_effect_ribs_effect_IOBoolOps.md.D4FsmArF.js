...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createStaticVNode('<h1 id="ioboolops" tabindex="-1">IOBoolOps <a class="header-anchor" href="#ioboolops" aria-label="Permalink to &quot;IOBoolOps&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">extension</span> <span class="fn">IOBoolOps</span> <span class="kw">on</span> <a href="./IO" class="type-link">IO</a>&lt;<span class="type">bool</span>&gt;</code></pre></div><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 3)),
