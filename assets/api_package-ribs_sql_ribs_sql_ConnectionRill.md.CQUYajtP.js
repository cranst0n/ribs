...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[29] || (_cache[29] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">ConnectionRill</span>&lt;A&gt;</code></pre></div><p>A deferred streaming query that produces a <a href="/api/package-ribs_rill_ribs_rill/Rill.html">Rill</a> that output elements of type <code>A</code> when transacted.</p><p>Analogous to <a href="/api/package-ribs_sql_ribs_sql/ConnectionIO.html">ConnectionIO</a> but for streaming: the database connection is kept open for the lifetime of the <a href="/api/package-ribs_rill_ribs_rill/Rill.html">Rill</a> and released when it terminates.</p><p>Obtain one via <a href="/api/package-ribs_sql_ribs_sql/Query.html#stream">Query.stream</a> or <a href="/api/package-ribs_sql_ribs_sql/ParameterizedQuery.html#stream">ParameterizedQuery.stream</a>, then execute with <a href="/api/package-ribs_sql_ribs_sql/ConnectionRill.html#transact">transact</a>.</p><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 5)),
