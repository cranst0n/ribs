...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[58] || (_cache[58] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">AreaDensity</span> <span class="kw">extends</span> <a href="./Quantity" class="type-link">Quantity</a>&lt;<a href="./AreaDensity" class="type-link">AreaDensity</a>&gt;</code></pre></div><p>A quantity representing areal (surface) mass density (mass per unit area).</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_units_ribs_units/Quantity.html">Quantity&lt;A extends Quantity&lt;A&gt;&gt;</a> → <strong>AreaDensity</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-areadensity" tabindex="-1">AreaDensity() <a class="header-anchor" href="#ctor-areadensity" aria-label="Permalink to &quot;AreaDensity() {#ctor-areadensity}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">AreaDensity</span>(<span class="type">double</span> <span class="param">value</span>, <a href="./UnitOfMeasure" class="type-link">UnitOfMeasure</a>&lt;<a href="./AreaDensity" class="type-link">AreaDensity</a>&gt; <span class="param">unit</span>)</code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">AreaDensity</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">super</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.value, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">super</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.unit);</span></span></code></pre></div></details><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 8)),
    ...
    _cache[75] || (_cache[75] = createStaticVNode('<div class="member-signature"><pre><code><a href="../package-ribs_core_ribs_core/Option" class="type-link">Option</a>&lt;<a href="./AreaDensity" class="type-link">AreaDensity</a>&gt; <span class="fn">parse</span>(<span class="type">String</span> <span class="param">s</span>)</code></pre></div><p>Parses <code>s</code> into an <a href="/ribs/api/package-ribs_units_ribs_units/AreaDensity.html">AreaDensity</a>, returning <a href="/ribs/api/package-ribs_core_ribs_core/None.html">None</a> if parsing fails.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Option</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">AreaDensity</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">parse</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> s) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Quantity</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">parse</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(s, units);</span></span></code></pre></div></details><h2 id="section-constants" tabindex="-1">Constants <a class="header-anchor" href="#section-constants" aria-label="Permalink to &quot;Constants {#section-constants}&quot;">​</a></h2><h3 id="prop-gramspersquarecentimeter" tabindex="-1">gramsPerSquareCentimeter <a class="header-anchor" href="#prop-gramspersquarecentimeter" aria-label="Permalink to &quot;gramsPerSquareCentimeter {#prop-gramspersquarecentimeter}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="kw">const</span> <a href="./AreaDensityUnit" class="type-link">AreaDensityUnit</a> <span class="fn">gramsPerSquareCentimeter</span></code></pre></div><p>Unit for grams per square centimeter (g/cm²).</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> AreaDensityUnit</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> gramsPerSquareCentimeter </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> GramsPerSquareCentimeter</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">._();</span></span></code></pre></div></details><h3 id="prop-kilogramspersquaremeter" tabindex="-1">kilogramsPerSquareMeter <a class="header-anchor" href="#prop-kilogramspersquaremeter" aria-label="Permalink to &quot;kilogramsPerSquareMeter {#prop-kilogramspersquaremeter}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="kw">const</span> <a href="./AreaDensityUnit" class="type-link">AreaDensityUnit</a> <span class="fn">kilogramsPerSquareMeter</span></code></pre></div><p>Unit for kilograms per square meter (kg/m²) — the SI unit of areal density.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> AreaDensityUnit</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> kilogramsPerSquareMeter </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> KilogramsPerSquareMeter</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">._();</span></span></code></pre></div></details><h3 id="prop-poundspersquarefoot" tabindex="-1">poundsPerSquareFoot <a class="header-anchor" href="#prop-poundspersquarefoot" aria-label="Permalink to &quot;poundsPerSquareFoot {#prop-poundspersquarefoot}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="kw">const</span> <a href="./AreaDensityUnit" class="type-link">AreaDensityUnit</a> <span class="fn">poundsPerSquareFoot</span></code></pre></div><p>Unit for pounds per square foot (lb/ft²).</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> AreaDensityUnit</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> poundsPerSquareFoot </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> PoundsPerSquareFoot</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">._();</span></span></code></pre></div></details><h3 id="prop-units" tabindex="-1">units <a class="header-anchor" href="#prop-units" aria-label="Permalink to &quot;units {#prop-units}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="kw">const</span> <span class="type">Set</span>&lt;<a href="./AreaDensityUnit" class="type-link">AreaDensityUnit</a>&gt; <span class="fn">units</span></code></pre></div><p>All supported <a href="/ribs/api/package-ribs_units_ribs_units/AreaDensity.html">AreaDensity</a> units.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> const</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> units </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>\n<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  kilogramsPerSquareMeter,</span></span>\n<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  gramsPerSquareCentimeter,</span></span>\n<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  poundsPerSquareFoot,</span></span>\n<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span></code></pre></div></details>', 20))
  ]);
}
