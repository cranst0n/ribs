...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createStaticVNode('<h1 id="ilisttuple2unzipops-a-b" tabindex="-1">IListTuple2UnzipOps&lt;A, B&gt; <a class="header-anchor" href="#ilisttuple2unzipops-a-b" aria-label="Permalink to &quot;IListTuple2UnzipOps\\&lt;A, B\\&gt;&quot;">​</a></h1><div class="member-signature"><div class="member-signature-code" data-signature-normalized="true"><span class="member-signature-line"><span class="member-signature-token"><span class="kw">extension</span></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="fn">IListTuple2UnzipOps</span></span><span class="member-signature-token">&lt;A, B&gt;</span><span class="member-signature-space"></span><span class="member-signature-token"><span class="kw">on</span></span><span class="member-signature-space"></span><span class="member-signature-token"><a href="./IList" class="type-link">IList</a></span><span class="member-signature-token">&lt;</span><span class="member-signature-token"><span class="type">Record</span></span><span class="member-signature-token">&gt;</span></span></div></div><p>Unzip operations for <a href="/ribs/api/package-ribs_core_ribs_core/IList.html">IList</a> of 2-tuples.</p><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
