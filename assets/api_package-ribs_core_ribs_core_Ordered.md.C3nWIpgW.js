...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[26] || (_cache[26] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">Ordered</span>&lt;A&gt; <span class="kw">implements</span> <span class="type">Comparable</span>&lt;<span class="type">A</span>&gt;</code></pre></div><div class="info custom-block"><p class="custom-block-title">Implemented types</p><ul><li>Comparable&lt;T&gt;</li></ul></div><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/ribs/api/package-ribs_ip_ribs_ip/Host.html">Host</a></li><li><a href="/ribs/api/package-ribs_ip_ribs_ip/HostnameLabel.html">HostnameLabel</a></li><li><a href="/ribs/api/package-ribs_ip_ribs_ip/IDNLabel.html">IDNLabel</a></li><li><a href="/ribs/api/package-ribs_ip_ribs_ip/MacAddress.html">MacAddress</a></li><li><a href="/ribs/api/package-ribs_ip_ribs_ip/Port.html">Port</a></li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 4)),
