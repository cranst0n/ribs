...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createStaticVNode('<h1 id="optionnestedops-a" tabindex="-1">OptionNestedOps&lt;A&gt; <a class="header-anchor" href="#optionnestedops-a" aria-label="Permalink to &quot;OptionNestedOps\\&lt;A\\&gt;&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">extension</span> <span class="fn">OptionNestedOps</span>&lt;A&gt; <span class="kw">on</span> <a href="./Option" class="type-link">Option</a>&lt;<a href="./Option" class="type-link">Option</a>&lt;<span class="type">A</span>&gt;&gt;</code></pre></div><p>Additional functions that can be called on a nested <a href="/api/package-ribs_core_ribs_core/Option.html">Option</a>.</p><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
