...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [..._cache[0] || (_cache[0] = [
    createStaticVNode('<h1 id="validatednel-e-a" tabindex="-1">ValidatedNel&lt;E, A&gt; <a class="header-anchor" href="#validatednel-e-a" aria-label="Permalink to &quot;ValidatedNel\\&lt;E, A\\&gt;&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">typedef</span> <span class="fn">ValidatedNel&lt;E, A&gt;</span> = <a href="./Validated" class="type-link">Validated</a>&lt;<a href="./NonEmptyIList" class="type-link">NonEmptyIList</a>&lt;<span class="type">E</span>&gt;, <span class="type">A</span>&gt;</code></pre></div><p>Type alias for <a href="/ribs/api/package-ribs_core_ribs_core/Validated.html">Validated</a> where the error case is fixed to <a href="./NonEmptyIList.html" class="api-link"><code>NonEmptyIList&lt;E&gt;</code></a>.</p>', 3)
  ])]);
}
