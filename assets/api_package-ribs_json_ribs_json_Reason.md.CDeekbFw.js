...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[20] || (_cache[20] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">sealed</span> <span class="kw">class</span> <span class="fn">Reason</span></code></pre></div><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/ribs/api/package-ribs_json_ribs_json/CustomReason.html">CustomReason</a></li><li><a href="/ribs/api/package-ribs_json_ribs_json/MissingField.html">MissingField</a></li><li><a href="/ribs/api/package-ribs_json_ribs_json/WrongTypeExpectation.html">WrongTypeExpectation</a></li></ul></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 3)),
