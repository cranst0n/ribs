...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[23] || (_cache[23] = createStaticVNode('<h1 id="monad-a" tabindex="-1">Monad&lt;A&gt; <a class="header-anchor" href="#monad-a" aria-label="Permalink to &quot;Monad\\&lt;A\\&gt;&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">mixin</span> <span class="fn">Monad</span>&lt;A&gt; <span class="kw">on</span> <a href="./Functor" class="type-link">Functor</a>&lt;<span class="type">A</span>&gt;, <a href="./Applicative" class="type-link">Applicative</a>&lt;<span class="type">A</span>&gt;</code></pre></div><p>Provides the ability to compose dependent effectful functions.</p><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/api/package-ribs_core_ribs_core/Either.html">Either&lt;A, B&gt;</a></li><li><a href="/api/package-ribs_check_ribs_check/Gen.html">Gen&lt;A&gt;</a></li><li><a href="/api/package-ribs_effect_ribs_effect/IO.html">IO&lt;A&gt;</a></li><li><a href="/api/package-ribs_effect_ribs_effect/Resource.html">Resource&lt;A&gt;</a></li><li><a href="/api/package-ribs_core_ribs_core/State.html">State&lt;S, A&gt;</a></li><li><a href="/api/package-ribs_effect_ribs_effect/SyncIO.html">SyncIO&lt;A&gt;</a></li></ul></div><div class="info custom-block"><p class="custom-block-title">Superclass Constraints</p><ul><li>Functor&lt;A&gt;</li><li>Applicative&lt;A&gt;</li></ul></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 6)),
