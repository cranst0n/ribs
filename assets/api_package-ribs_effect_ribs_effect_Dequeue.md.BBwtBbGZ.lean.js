...
const __pageData = JSON.parse('{"title":"Dequeue","description":"API documentation for Dequeue<A> class from ribs_effect","frontmatter":{"title":"Dequeue<A>","description":"API documentation for Dequeue<A> class from ribs_effect","category":"Classes","library":"ribs_effect","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_effect_ribs_effect/Dequeue.md","filePath":"api/package-ribs_effect_ribs_effect/Dequeue.md"}');
const _sfc_main = { name: "api/package-ribs_effect_ribs_effect/Dequeue.md" };
const _hoisted_1 = {
  id: "dequeue-a",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Dequeue<A> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#dequeue-a",
        "aria-label": 'Permalink to "Dequeue\\<A\\> <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    ...
    createBaseVNode("h3", _hoisted_5, [
      ...
      _cache[16] || (_cache[16] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#offer",
        "aria-label": 'Permalink to "offer() <Badge type="info" text="override" /> {#offer}"'
      }, "​", -1))
    ]),
    _cache[51] || (_cache[51] = createStaticVNode("", 15)),
    ...
    _cache[53] || (_cache[53] = createStaticVNode("", 11)),
    ...
    _cache[54] || (_cache[54] = createStaticVNode("", 6)),
    createBaseVNode("h3", _hoisted_9, [
      ...
      _cache[28] || (_cache[28] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#tryoffer",
        "aria-label": 'Permalink to "tryOffer() <Badge type="info" text="override" /> {#tryoffer}"'
      }, "​", -1))
    ]),
    _cache[55] || (_cache[55] = createStaticVNode("", 20)),
    ...
    createBaseVNode("h3", _hoisted_11, [
      ...
      _cache[34] || (_cache[34] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#trytake",
        "aria-label": 'Permalink to "tryTake() <Badge type="info" text="override" /> {#trytake}"'
      }, "​", -1))
    ]),
    _cache[57] || (_cache[57] = createStaticVNode("", 20)),
...
const Dequeue = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Dequeue as default
};
