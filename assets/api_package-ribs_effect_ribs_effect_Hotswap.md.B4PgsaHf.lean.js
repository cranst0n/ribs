...
const __pageData = JSON.parse('{"title":"Hotswap","description":"API documentation for Hotswap<R> class from ribs_effect","frontmatter":{"title":"Hotswap<R>","description":"API documentation for Hotswap<R> class from ribs_effect","category":"Classes","library":"ribs_effect","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_effect_ribs_effect/Hotswap.md","filePath":"api/package-ribs_effect_ribs_effect/Hotswap.md"}');
const _sfc_main = { name: "api/package-ribs_effect_ribs_effect/Hotswap.md" };
const _hoisted_1 = {
  id: "hotswap-r",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Hotswap<R> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#hotswap-r",
        "aria-label": 'Permalink to "Hotswap\\<R\\> <Badge type="info" text="sealed" />"'
      }, "​", -1))
    ]),
    _cache[23] || (_cache[23] = createStaticVNode("", 2)),
    createBaseVNode("h3", _hoisted_2, [
      _cache[3] || (_cache[3] = createTextVNode("current ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "no setter"
      }),
...
const Hotswap = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Hotswap as default
};
