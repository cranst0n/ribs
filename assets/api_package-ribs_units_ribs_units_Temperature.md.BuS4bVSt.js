...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[82] || (_cache[82] = createStaticVNode('<div class="member-signature"><pre><code><a href="./Temperature" class="type-link">Temperature</a> <span class="kw">get</span> <span class="fn">toCelsius</span></code></pre></div><p>Converts this temperature to the Celsius scale.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Temperature</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toCelsius </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> _convert</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(celcius);</span></span></code></pre></div></details>', 3)),
    ...
    _cache[84] || (_cache[84] = createStaticVNode('<div class="member-signature"><pre><code><a href="./Temperature" class="type-link">Temperature</a> <span class="kw">get</span> <span class="fn">toFahrenheit</span></code></pre></div><p>Converts this temperature to the Fahrenheit scale.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Temperature</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toFahrenheit </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> _convert</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(fahrenheit);</span></span></code></pre></div></details>', 3)),
    ...
    _cache[86] || (_cache[86] = createStaticVNode('<div class="member-signature"><pre><code><a href="./Temperature" class="type-link">Temperature</a> <span class="kw">get</span> <span class="fn">toKelvin</span></code></pre></div><p>Converts this temperature to the Kelvin scale.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Temperature</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toKelvin </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> _convert</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(kelvin);</span></span></code></pre></div></details>', 3)),
    ...
    _cache[88] || (_cache[88] = createStaticVNode('<div class="member-signature"><pre><code><a href="./Temperature" class="type-link">Temperature</a> <span class="kw">get</span> <span class="fn">toRankine</span></code></pre></div><p>Converts this temperature to the Rankine scale.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Temperature</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> toRankine </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> _convert</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(rankine);</span></span></code></pre></div></details>', 3)),
    ...
    _cache[91] || (_cache[91] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">double</span> <span class="fn">value</span></code></pre></div><p>The raw numeric value of this quantity expressed in <a href="/ribs/api/package-ribs_units_ribs_units/Quantity.html#prop-unit">unit</a>.</p><p><em>Inherited from Quantity.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> double</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> value;</span></span></code></pre></div></details><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 5)),
