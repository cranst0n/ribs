...
const __pageData = JSON.parse('{"title":"SqlConnection","description":"API documentation for SqlConnection class from ribs_sql","frontmatter":{"title":"SqlConnection","description":"API documentation for SqlConnection class from ribs_sql","category":"Classes","library":"ribs_sql","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_sql_ribs_sql/SqlConnection.md","filePath":"api/package-ribs_sql_ribs_sql/SqlConnection.md"}');
const _sfc_main = { name: "api/package-ribs_sql_ribs_sql/SqlConnection.md" };
const _hoisted_1 = {
  id: "sqlconnection",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("SqlConnection ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#sqlconnection",
        "aria-label": 'Permalink to "SqlConnection <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    ...
    _cache[22] || (_cache[22] = createStaticVNode("", 26)),
...
const SqlConnection = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  SqlConnection as default
};
