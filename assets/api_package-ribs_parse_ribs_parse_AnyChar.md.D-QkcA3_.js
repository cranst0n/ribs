...
const __pageData = JSON.parse('{"title":"AnyChar","description":"API documentation for AnyChar class from ribs_parse","frontmatter":{"title":"AnyChar","description":"API documentation for AnyChar class from ribs_parse","category":"Classes","library":"ribs_parse","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_parse_ribs_parse/AnyChar.md","filePath":"api/package-ribs_parse_ribs_parse/AnyChar.md"}');
const _sfc_main = { name: "api/package-ribs_parse_ribs_parse/AnyChar.md" };
const _hoisted_1 = {
  id: "anychar",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("AnyChar ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#anychar",
        "aria-label": 'Permalink to "AnyChar <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
    _cache[137] || (_cache[137] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">AnyChar</span> <span class="kw">extends</span> <a href="./Parser" class="type-link">Parser</a>&lt;<span class="type">String</span>&gt;</code></pre></div><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser0.html">Parser0&lt;A&gt;</a> → <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser.html">Parser&lt;A&gt;</a> → <strong>AnyChar</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-anychar" tabindex="-1">AnyChar() <a class="header-anchor" href="#ctor-anychar" aria-label="Permalink to &quot;AnyChar() {#ctor-anychar}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">AnyChar</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 6)),
    ...
    _cache[144] || (_cache[144] = createStaticVNode('<div class="member-signature"><pre><code><a href="./Soft" class="type-link">Soft</a>&lt;<span class="type">String</span>&gt; <span class="kw">get</span> <span class="fn">soft</span></code></pre></div><p>Returns a <a href="/ribs/api/package-ribs_parse_ribs_parse/Soft0.html">Soft0</a> view that uses soft (backtracking) product combinators.</p><p>In a soft product <code>a.soft.product(b)</code>, a failure in <code>b</code> backtracks to before <code>a</code> ran, allowing the failure to be caught by <a href="/ribs/api/package-ribs_parse_ribs_parse/AnyChar.html#orelse">orElse</a>.</p><p><em>Inherited from Parser.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@override</span></span>\n<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Soft</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> soft </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Soft</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span></code></pre></div></details>', 5)),
    ...
    _cache[147] || (_cache[147] = createStaticVNode('<div class="member-signature"><pre><code><a href="./With1" class="type-link">With1</a>&lt;<span class="type">String</span>&gt; <span class="kw">get</span> <span class="fn">with1</span></code></pre></div><p>Promotes this <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser0.html">Parser0</a> so it can be sequenced with a <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser.html">Parser</a> to produce a <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser.html">Parser</a> result.</p><p>All combinators on <a href="/ribs/api/package-ribs_parse_ribs_parse/With1.html">With1</a> return <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser.html">Parser</a> instead of <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser0.html">Parser0</a>, which is useful when at least one side of a product is known to consume input.</p><p><em>Inherited from Parser0.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">With1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> with1 </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> With1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span></code></pre></div></details>', 5)),
