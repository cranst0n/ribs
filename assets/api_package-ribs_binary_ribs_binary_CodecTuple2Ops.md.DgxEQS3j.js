...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createStaticVNode('<h1 id="codectuple2ops-t0-t1" tabindex="-1">CodecTuple2Ops&lt;T0, T1&gt; <a class="header-anchor" href="#codectuple2ops-t0-t1" aria-label="Permalink to &quot;CodecTuple2Ops\\&lt;T0, T1\\&gt;&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">extension</span> <span class="fn">CodecTuple2Ops</span>&lt;T0, T1&gt; <span class="kw">on</span> <span class="type">Record</span></code></pre></div><p>Provides a product operation on a 2-tuple of <a href="/api/package-ribs_binary_ribs_binary/Codec.html">Codec</a>s.</p><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
