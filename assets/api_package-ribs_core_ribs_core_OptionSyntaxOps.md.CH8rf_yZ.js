...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createStaticVNode('<h1 id="optionsyntaxops-a" tabindex="-1">OptionSyntaxOps&lt;A&gt; <a class="header-anchor" href="#optionsyntaxops-a" aria-label="Permalink to &quot;OptionSyntaxOps\\&lt;A\\&gt;&quot;">​</a></h1><div class="member-signature"><div class="member-signature-code" data-signature-normalized="true"><span class="member-signature-line"><span class="member-signature-token"><span class="kw">extension</span></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="fn">OptionSyntaxOps</span></span><span class="member-signature-token">&lt;A&gt;</span><span class="member-signature-space"></span><span class="member-signature-token"><span class="kw">on</span></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="type">A</span></span></span></div></div><p>Operations for any value to lift it into an <a href="/ribs/api/package-ribs_core_ribs_core/Option.html">Option</a>.</p><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 4)),
