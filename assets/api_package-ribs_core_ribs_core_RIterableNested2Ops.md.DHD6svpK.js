...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createStaticVNode('<h1 id="riterablenested2ops-a" tabindex="-1">RIterableNested2Ops&lt;A&gt; <a class="header-anchor" href="#riterablenested2ops-a" aria-label="Permalink to &quot;RIterableNested2Ops\\&lt;A\\&gt;&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">extension</span> <span class="fn">RIterableNested2Ops</span>&lt;A&gt; <span class="kw">on</span> <a href="./RIterable" class="type-link">RIterable</a>&lt;<a href="./RIterable" class="type-link">RIterable</a>&lt;<span class="type">A</span>&gt;&gt;</code></pre></div><p>Operations available when <a href="/ribs/api/package-ribs_core_ribs_core/RIterable.html">RIterable</a> elements are themselves <a href="/ribs/api/package-ribs_core_ribs_core/RIterable.html">RIterable</a>.</p><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
