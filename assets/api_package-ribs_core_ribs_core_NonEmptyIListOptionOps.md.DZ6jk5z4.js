...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createStaticVNode('<h1 id="nonemptyilistoptionops-a" tabindex="-1">NonEmptyIListOptionOps&lt;A&gt; <a class="header-anchor" href="#nonemptyilistoptionops-a" aria-label="Permalink to &quot;NonEmptyIListOptionOps\\&lt;A\\&gt;&quot;">​</a></h1><div class="member-signature"><div class="member-signature-code" data-signature-normalized="true"><span class="member-signature-line"><span class="member-signature-token"><span class="kw">extension</span></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="fn">NonEmptyIListOptionOps</span></span><span class="member-signature-token">&lt;A&gt;</span><span class="member-signature-space"></span><span class="member-signature-token"><span class="kw">on</span></span><span class="member-signature-space"></span><span class="member-signature-token"><a href="./NonEmptyIList" class="type-link">NonEmptyIList</a></span><span class="member-signature-token">&lt;</span><span class="member-signature-token"><a href="./Option" class="type-link">Option</a></span><span class="member-signature-token">&lt;</span><span class="member-signature-token"><span class="type">A</span></span><span class="member-signature-token">&gt;&gt;</span></span></div></div><p>Operations available when <a href="/ribs/api/package-ribs_core_ribs_core/NonEmptyIList.html">NonEmptyIList</a> elements are <a href="/ribs/api/package-ribs_core_ribs_core/Option.html">Option</a> values.</p><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
