...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[26] || (_cache[26] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">ServerSocket</span></code></pre></div><p>A server socket that listens for incoming TCP connections.</p><p>Obtain instances via <a href="./Network.html" class="api-link"><code>Network.server</code></a> (which returns a resource-managed server that is automatically closed on release). The <a href="/ribs/api/package-ribs_rill_io_ribs_rill_io/ServerSocket.html#prop-accept">accept</a> Rill emits connected <a href="/ribs/api/package-ribs_rill_io_ribs_rill_io/Socket.html">Socket</a> instances, each of which should be closed by the caller when done (e.g. via <a href="/ribs/api/package-ribs_effect_ribs_effect/Resource.html">Resource</a> or <a href="/ribs/api/package-ribs_effect_ribs_effect/IO.html#bracket">IO.bracket</a>).</p><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-serversocket" tabindex="-1">ServerSocket() <a class="header-anchor" href="#ctor-serversocket" aria-label="Permalink to &quot;ServerSocket() {#ctor-serversocket}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">ServerSocket</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 7)),
    ...
    _cache[29] || (_cache[29] = createStaticVNode('<div class="member-signature"><pre><code><a href="../package-ribs_ip_ribs_ip/SocketAddress" class="type-link">SocketAddress</a>&lt;<a href="../package-ribs_ip_ribs_ip/Host" class="type-link">Host</a>&gt; <span class="kw">get</span> <span class="fn">localAddress</span></code></pre></div><p>The local address this server is bound to.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">SocketAddress</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> localAddress;</span></span></code></pre></div></details>', 3)),
