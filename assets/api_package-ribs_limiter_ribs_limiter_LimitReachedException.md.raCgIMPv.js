...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[20] || (_cache[20] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">LimitReachedException</span> <span class="kw">implements</span> <span class="type">Exception</span></code></pre></div><p>Thrown when a job cannot be enqueued because the limiter&#39;s maximum queue size has been reached.</p><div class="info custom-block"><p class="custom-block-title">Implemented types</p><ul><li>Exception</li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-limitreachedexception" tabindex="-1">LimitReachedException() <a class="header-anchor" href="#ctor-limitreachedexception" aria-label="Permalink to &quot;LimitReachedException() {#ctor-limitreachedexception}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">LimitReachedException</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 7)),
