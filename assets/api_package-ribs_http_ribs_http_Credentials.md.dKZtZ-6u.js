...
const __pageData = JSON.parse('{"title":"Credentials","description":"API documentation for Credentials class from ribs_http","frontmatter":{"title":"Credentials","description":"API documentation for Credentials class from ribs_http","category":"Classes","library":"ribs_http","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_http_ribs_http/Credentials.md","filePath":"api/package-ribs_http_ribs_http/Credentials.md"}');
const _sfc_main = { name: "api/package-ribs_http_ribs_http/Credentials.md" };
const _hoisted_1 = {
  id: "credentials",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Credentials ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#credentials",
        "aria-label": 'Permalink to "Credentials <Badge type="info" text="sealed" />"'
      }, "​", -1))
    ]),
    _cache[23] || (_cache[23] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">sealed</span> <span class="kw">class</span> <span class="fn">Credentials</span></code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 2)),
    createBaseVNode("h3", _hoisted_2, [
      _cache[3] || (_cache[3] = createTextVNode("authScheme ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "no setter"
      }),
      ...
      _cache[5] || (_cache[5] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-authscheme",
        "aria-label": 'Permalink to "authScheme <Badge type="tip" text="no setter" /> {#prop-authscheme}"'
      }, "​", -1))
    ]),
    _cache[24] || (_cache[24] = createStaticVNode('<div class="member-signature"><pre><code><a href="./AuthScheme" class="type-link">AuthScheme</a> <span class="kw">get</span> <span class="fn">authScheme</span></code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">AuthScheme</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> authScheme;</span></span></code></pre></div></details>', 2)),
