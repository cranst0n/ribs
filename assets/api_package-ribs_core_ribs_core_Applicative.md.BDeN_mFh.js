...
const __pageData = JSON.parse('{"title":"Applicative","description":"API documentation for Applicative<A> mixin from ribs_core","frontmatter":{"title":"Applicative<A>","description":"API documentation for Applicative<A> mixin from ribs_core","category":"Mixins","library":"ribs_core","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_core_ribs_core/Applicative.md","filePath":"api/package-ribs_core_ribs_core/Applicative.md"}');
const _sfc_main = { name: "api/package-ribs_core_ribs_core/Applicative.md" };
const _hoisted_1 = {
  id: "prop-hashcode",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[20] || (_cache[20] = createStaticVNode('<h1 id="applicative-a" tabindex="-1">Applicative&lt;A&gt; <a class="header-anchor" href="#applicative-a" aria-label="Permalink to &quot;Applicative\\&lt;A\\&gt;&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">mixin</span> <span class="fn">Applicative</span>&lt;A&gt; <span class="kw">on</span> <a href="./Functor" class="type-link">Functor</a>&lt;<span class="type">A</span>&gt;</code></pre></div><p>Provides the application of a function in an Applicative context to a value in an Applicative context.</p><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/ribs/api/package-ribs_check_ribs_check/Gen.html">Gen&lt;A&gt;</a></li><li><a href="/ribs/api/package-ribs_effect_ribs_effect/IO.html">IO&lt;A&gt;</a></li><li><a href="/ribs/api/package-ribs_core_ribs_core/Monad.html">Monad&lt;A&gt;</a></li><li><a href="/ribs/api/package-ribs_effect_ribs_effect/Resource.html">Resource&lt;A&gt;</a></li><li><a href="/ribs/api/package-ribs_core_ribs_core/State.html">State&lt;S, A&gt;</a></li><li><a href="/ribs/api/package-ribs_effect_ribs_effect/SyncIO.html">SyncIO&lt;A&gt;</a></li></ul></div><div class="info custom-block"><p class="custom-block-title">Superclass Constraints</p><ul><li>Functor&lt;A&gt;</li></ul></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 6)),
    ...
    _cache[22] || (_cache[22] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">Type</span> <span class="kw">get</span> <span class="fn">runtimeType</span></code></pre></div><p>A representation of the runtime type of the object.</p><p><em>Inherited from Object.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">external</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Type</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> runtimeType;</span></span></code></pre></div></details><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2><h3 id="ap" tabindex="-1">ap() <a class="header-anchor" href="#ap" aria-label="Permalink to &quot;ap() {#ap}&quot;">​</a></h3><div class="member-signature"><pre><code><a href="./Applicative" class="type-link">Applicative</a>&lt;<span class="type">B</span>&gt; <span class="fn">ap&lt;B&gt;</span>(<a href="./Applicative" class="type-link">Applicative</a>&lt;<span class="type">B</span> <span class="type">Function</span>(<span class="type">A</span>)&gt; <span class="param">f</span>)</code></pre></div><p>Apply <code>f</code> to the value of this <a href="/ribs/api/package-ribs_core_ribs_core/Applicative.html">Applicative</a>.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Applicative</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">B</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">ap</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">B</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Applicative</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Function1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">B</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;&gt; f);</span></span></code></pre></div></details>', 9)),
    createBaseVNode("h3", _hoisted_3, [
      _cache[8] || (_cache[8] = createTextVNode("map() ", -1)),
      createVNode(_component_Badge, {
        type: "info",
        text: "inherited"
      }),
    ...
    _cache[23] || (_cache[23] = createStaticVNode('<div class="member-signature"><pre><code><a href="./Functor" class="type-link">Functor</a>&lt;<span class="type">B</span>&gt; <span class="fn">map&lt;B&gt;</span>(<span class="type">B</span> <span class="type">Function</span>(<span class="type">A</span>) <span class="param">f</span>)</code></pre></div><p>Applies <code>f</code> to the value of this <a href="/ribs/api/package-ribs_core_ribs_core/Functor.html">Functor</a>.</p><p><em>Inherited from Functor.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Functor</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">B</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">map</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">B</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Function1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">B</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; f);</span></span></code></pre></div></details>', 4)),
...
const Applicative = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Applicative as default
};
