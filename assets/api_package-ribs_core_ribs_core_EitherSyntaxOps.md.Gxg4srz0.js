...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[6] || (_cache[6] = createStaticVNode('<h1 id="eithersyntaxops-a" tabindex="-1">EitherSyntaxOps&lt;A&gt; <a class="header-anchor" href="#eithersyntaxops-a" aria-label="Permalink to &quot;EitherSyntaxOps\\&lt;A\\&gt;&quot;">​</a></h1><div class="member-signature"><div class="member-signature-code" data-signature-normalized="true"><span class="member-signature-line"><span class="member-signature-token"><span class="kw">extension</span></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="fn">EitherSyntaxOps</span></span><span class="member-signature-token">&lt;A&gt;</span><span class="member-signature-space"></span><span class="member-signature-token"><span class="kw">on</span></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="type">A</span></span></span></div></div><p>Operations for any value to lift it into an <a href="/ribs/api/package-ribs_core_ribs_core/Either.html">Either</a>.</p><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
