...
const __pageData = JSON.parse('{"title":"Ref","description":"API documentation for Ref<A> class from ribs_effect","frontmatter":{"title":"Ref<A>","description":"API documentation for Ref<A> class from ribs_effect","category":"Classes","library":"ribs_effect","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_effect_ribs_effect/Ref.md","filePath":"api/package-ribs_effect_ribs_effect/Ref.md"}');
const _sfc_main = { name: "api/package-ribs_effect_ribs_effect/Ref.md" };
const _hoisted_1 = {
  id: "ref-a",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Ref<A> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#ref-a",
        "aria-label": 'Permalink to "Ref\\<A\\> <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    ...
    _cache[22] || (_cache[22] = createStaticVNode("", 30)),
...
const Ref = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Ref as default
};
