import { r as resolveComponent, o as openBlock, c as createElementBlock, e as createStaticVNode, a as createBaseVNode, b as createTextVNode, d as createVNode, _ as _export_sfc } from "./app.BfghP1Kx.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[25] || (_cache[25] = createStaticVNode('<h1 id="asyncparsermode" tabindex="-1">AsyncParserMode <a class="header-anchor" href="#asyncparsermode" aria-label="Permalink to &quot;AsyncParserMode&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">enum</span> <span class="fn">AsyncParserMode</span></code></pre></div><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → Enum → <strong>AsyncParserMode</strong></p></div><div class="info custom-block"><p class="custom-block-title">Available Extensions</p><ul><li>EnumName</li></ul></div><h2 id="section-values" tabindex="-1">Values <a class="header-anchor" href="#section-values" aria-label="Permalink to &quot;Values {#section-values}&quot;">​</a></h2><h3 id="value-unwraparray" tabindex="-1">unwrapArray <a class="header-anchor" href="#value-unwraparray" aria-label="Permalink to &quot;unwrapArray {#value-unwraparray}&quot;">​</a></h3><h3 id="value-valuestream" tabindex="-1">valueStream <a class="header-anchor" href="#value-valuestream" aria-label="Permalink to &quot;valueStream {#value-valuestream}&quot;">​</a></h3><h3 id="value-singlevalue" tabindex="-1">singleValue <a class="header-anchor" href="#value-singlevalue" aria-label="Permalink to &quot;singleValue {#value-singlevalue}&quot;">​</a></h3><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 9)),
