...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[24] || (_cache[24] = createStaticVNode('<h1 id="watcherdeletedevent" tabindex="-1">WatcherDeletedEvent <a class="header-anchor" href="#watcherdeletedevent" aria-label="Permalink to &quot;WatcherDeletedEvent&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">WatcherDeletedEvent</span> <span class="kw">extends</span> <a href="./WatcherEvent" class="type-link">WatcherEvent</a></code></pre></div><p>Emitted when a file or directory at <a href="/ribs/api/package-ribs_rill_io_ribs_rill_io/WatcherEvent.html#prop-path">path</a> is deleted.</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_rill_io_ribs_rill_io/WatcherEvent.html">WatcherEvent</a> → <strong>WatcherDeletedEvent</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 5)),
