...
const __pageData = JSON.parse('{"title":"KeyEncoder","description":"API documentation for KeyEncoder<A> class from ribs_json","frontmatter":{"title":"KeyEncoder<A>","description":"API documentation for KeyEncoder<A> class from ribs_json","category":"Classes","library":"ribs_json","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_json_ribs_json/KeyEncoder.md","filePath":"api/package-ribs_json_ribs_json/KeyEncoder.md"}');
const _sfc_main = { name: "api/package-ribs_json_ribs_json/KeyEncoder.md" };
const _hoisted_1 = {
  id: "keyencoder-a",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("KeyEncoder<A> ", -1)),
      ...
      _cache[3] || (_cache[3] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#keyencoder-a",
        "aria-label": 'Permalink to "KeyEncoder\\<A\\> <Badge type="info" text="abstract" /> <Badge type="info" text="mixin" />"'
      }, "​", -1))
    ]),
    _cache[21] || (_cache[21] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">mixin</span> <span class="kw">class</span> <span class="fn">KeyEncoder</span>&lt;A&gt;</code></pre></div><p><strong>Annotations:</strong> <code>@immutable</code></p><p>Converts values of type <code>A</code> to JSON object key strings.</p><p>Used alongside <a href="/ribs/api/package-ribs_json_ribs_json/KeyDecoder.html">KeyDecoder</a> and <a href="/ribs/api/package-ribs_json_ribs_json/KeyCodec.html">KeyCodec</a> to support typed keys in <a href="/ribs/api/package-ribs_json_ribs_json/JsonObject.html">JsonObject</a>-backed <a href="https://api.dart.dev/stable/3.11.5/dart-core/Map-class.html" target="_blank" rel="noreferrer">Map</a> encoding.</p><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/ribs/api/package-ribs_json_ribs_json/KeyCodec.html">KeyCodec&lt;A&gt;</a></li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-keyencoder" tabindex="-1">KeyEncoder() <a class="header-anchor" href="#ctor-keyencoder" aria-label="Permalink to &quot;KeyEncoder() {#ctor-keyencoder}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">KeyEncoder</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 9)),
    ...
    _cache[23] || (_cache[23] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">Type</span> <span class="kw">get</span> <span class="fn">runtimeType</span></code></pre></div><p>A representation of the runtime type of the object.</p><p><em>Inherited from Object.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">external</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Type</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> runtimeType;</span></span></code></pre></div></details><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2><h3 id="encode" tabindex="-1">encode() <a class="header-anchor" href="#encode" aria-label="Permalink to &quot;encode() {#encode}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="type">String</span> <span class="fn">encode</span>(<span class="type">A</span> <span class="param">a</span>)</code></pre></div><p>Encodes <code>a</code> as a JSON object key string.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">String</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> encode</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> a);</span></span></code></pre></div></details>', 9)),
