...
const __pageData = JSON.parse('{"title":"Alphabet","description":"API documentation for Alphabet class from ribs_binary","frontmatter":{"title":"Alphabet","description":"API documentation for Alphabet class from ribs_binary","category":"Classes","library":"ribs_binary","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_binary_ribs_binary/Alphabet.md","filePath":"api/package-ribs_binary_ribs_binary/Alphabet.md"}');
const _sfc_main = { name: "api/package-ribs_binary_ribs_binary/Alphabet.md" };
const _hoisted_1 = {
  id: "alphabet",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Alphabet ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#alphabet",
        "aria-label": 'Permalink to "Alphabet <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    _cache[23] || (_cache[23] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">Alphabet</span></code></pre></div><p>Defines the bidirectional mapping between integer indices and characters for a positional numeral system.</p><p>An alphabet provides the character set used for encoding and decoding binary data in a particular base. Implementations define the valid characters, their corresponding numeric values, and which characters should be silently ignored (e.g. whitespace, separators).</p><p>See also:</p><ul><li><a href="/ribs/api/package-ribs_binary_ribs_binary/PaddedAlphabet.html">PaddedAlphabet</a>, for alphabets that include a padding character.</li><li><a href="/ribs/api/package-ribs_binary_ribs_binary/Alphabets.html">Alphabets</a>, for pre-defined alphabet instances.</li></ul><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/ribs/api/package-ribs_binary_ribs_binary/Base58Alphabet.html">Base58Alphabet</a></li><li><a href="/ribs/api/package-ribs_binary_ribs_binary/BinaryAlphabet.html">BinaryAlphabet</a></li><li><a href="/ribs/api/package-ribs_binary_ribs_binary/HexAlphabet.html">HexAlphabet</a></li><li><a href="/ribs/api/package-ribs_binary_ribs_binary/PaddedAlphabet.html">PaddedAlphabet</a></li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 7)),
    createBaseVNode("h3", _hoisted_2, [
      _cache[3] || (_cache[3] = createTextVNode("Alphabet() ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "const"
      }),
      ...
      _cache[5] || (_cache[5] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#ctor-alphabet",
        "aria-label": 'Permalink to "Alphabet() <Badge type="tip" text="const" /> {#ctor-alphabet}"'
      }, "​", -1))
    ]),
    _cache[24] || (_cache[24] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">const</span> <span class="fn">Alphabet</span>()</code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Alphabet</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></details><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 3)),
    ...
    _cache[26] || (_cache[26] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">Type</span> <span class="kw">get</span> <span class="fn">runtimeType</span></code></pre></div><p>A representation of the runtime type of the object.</p><p><em>Inherited from Object.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">external</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Type</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> runtimeType;</span></span></code></pre></div></details><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2><h3 id="ignore" tabindex="-1">ignore() <a class="header-anchor" href="#ignore" aria-label="Permalink to &quot;ignore() {#ignore}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="type">bool</span> <span class="fn">ignore</span>(<span class="type">String</span> <span class="param">c</span>)</code></pre></div><p>Returns <code>true</code> if the given character <code>c</code> should be silently ignored during decoding.</p><p>Commonly returns <code>true</code> for whitespace, underscores, or other visual separators that may appear in formatted input.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">bool</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> ignore</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> c);</span></span></code></pre></div></details>', 10)),
...
const Alphabet = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  Alphabet as default
};
