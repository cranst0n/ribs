...
const __pageData = JSON.parse('{"title":"SourceSpecificMulticast","description":"API documentation for SourceSpecificMulticast<A extends IpAddress> class from ribs_ip","frontmatter":{"title":"SourceSpecificMulticast<A extends IpAddress>","description":"API documentation for SourceSpecificMulticast<A extends IpAddress> class from ribs_ip","category":"Classes","library":"ribs_ip","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_ip_ribs_ip/SourceSpecificMulticast.md","filePath":"api/package-ribs_ip_ribs_ip/SourceSpecificMulticast.md"}');
const _sfc_main = { name: "api/package-ribs_ip_ribs_ip/SourceSpecificMulticast.md" };
const _hoisted_1 = {
  id: "sourcespecificmulticast-a-extends-ipaddress",
  tabindex: "-1"
};
const _hoisted_2 = {
  id: "prop-address",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("SourceSpecificMulticast<A extends IpAddress> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#sourcespecificmulticast-a-extends-ipaddress",
        "aria-label": 'Permalink to "SourceSpecificMulticast\\<A extends IpAddress\\> <Badge type="info" text="sealed" />"'
      }, "​", -1))
    ]),
    _cache[27] || (_cache[27] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">sealed</span> <span class="kw">class</span> <span class="fn">SourceSpecificMulticast</span>&lt;A <span class="kw">extends</span> <a href="./IpAddress" class="type-link">IpAddress</a>&gt; <span class="kw">extends</span> <a href="./Multicast" class="type-link">Multicast</a>&lt;<span class="type">A</span>&gt;</code></pre></div><p>A <a href="/ribs/api/package-ribs_ip_ribs_ip/Multicast.html">Multicast</a> address that falls within the source-specific multicast (SSM) range, or any multicast address when constructed leniently.</p><p>Use <a href="/ribs/api/package-ribs_ip_ribs_ip/SourceSpecificMulticast.html#fromipaddress">fromIpAddress</a> for strict SSM construction (requires the address to be within the SSM range) or <a href="/ribs/api/package-ribs_ip_ribs_ip/SourceSpecificMulticast.html#fromipaddresslenient">fromIpAddressLenient</a> to accept any multicast address.</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_ip_ribs_ip/Multicast.html">Multicast&lt;A extends IpAddress&gt;</a> → <strong>SourceSpecificMulticast&lt;A extends IpAddress&gt;</strong></p></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 5)),
    ...
    _cache[28] || (_cache[28] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">A</span> <span class="fn">address</span></code></pre></div><p>The underlying multicast IP address.</p><p><em>Inherited from Multicast.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> address;</span></span></code></pre></div></details>', 4)),
    ...
    createBaseVNode("h3", _hoisted_8, [
      ...
      _cache[26] || (_cache[26] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#fromipaddress",
        "aria-label": 'Permalink to "fromIpAddress() <Badge type="info" text="override" /> {#fromipaddress}"'
      }, "​", -1))
    ]),
    _cache[34] || (_cache[34] = createStaticVNode('<div class="member-signature"><pre><code><a href="../package-ribs_core_ribs_core/Option" class="type-link">Option</a>&lt;<a href="./SourceSpecificMulticastStrict" class="type-link">SourceSpecificMulticastStrict</a>&lt;<span class="type">A</span>&gt;&gt; <span class="fn">fromIpAddress&lt;A extends IpAddress&gt;</span>(\n  <span class="type">A</span> <span class="param">address</span>,\n)</code></pre></div><p>Returns a <a href="/ribs/api/package-ribs_ip_ribs_ip/SourceSpecificMulticastStrict.html">SourceSpecificMulticastStrict</a> for <code>address</code> if it is in the source-specific multicast range, otherwise <a href="/ribs/api/package-ribs_core_ribs_core/None.html">None</a>.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Option</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">SourceSpecificMulticastStrict</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">fromIpAddress</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> extends</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> IpAddress</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;(</span></span>\n<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">  A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> address,</span></span>\n<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Option</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">when</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span></span>\n<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  () </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> address.isSourceSpecificMulticast,</span></span>\n<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  () </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> _DefaultSourceSpecificMulticastStrict</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">._(address),</span></span>\n<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span></code></pre></div></details><h3 id="fromipaddresslenient" tabindex="-1">fromIpAddressLenient() <a class="header-anchor" href="#fromipaddresslenient" aria-label="Permalink to &quot;fromIpAddressLenient() {#fromipaddresslenient}&quot;">​</a></h3><div class="member-signature"><pre><code><a href="../package-ribs_core_ribs_core/Option" class="type-link">Option</a>&lt;<a href="./SourceSpecificMulticast" class="type-link">SourceSpecificMulticast</a>&lt;<span class="type">A</span>&gt;&gt; <span class="fn">fromIpAddressLenient&lt;A extends IpAddress&gt;</span>(\n  <span class="type">A</span> <span class="param">address</span>,\n)</code></pre></div><p>Returns a <a href="/ribs/api/package-ribs_ip_ribs_ip/SourceSpecificMulticast.html">SourceSpecificMulticast</a> for <code>address</code> if it is any multicast address (not limited to the strict SSM range), otherwise <a href="/ribs/api/package-ribs_core_ribs_core/None.html">None</a>.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Option</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">SourceSpecificMulticast</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;&gt; </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">fromIpAddressLenient</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> extends</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> IpAddress</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> address) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span></span>\n<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">    Option</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">when</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(() </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> address.isMulticast, () </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> _unsafeCreate</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(address));</span></span></code></pre></div></details>', 7))
  ]);
}
const SourceSpecificMulticast = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  SourceSpecificMulticast as default
};
