...
const __pageData = JSON.parse('{"title":"MacAddress","description":"API documentation for MacAddress class from ribs_ip","frontmatter":{"title":"MacAddress","description":"API documentation for MacAddress class from ribs_ip","category":"Classes","library":"ribs_ip","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_ip_ribs_ip/MacAddress.md","filePath":"api/package-ribs_ip_ribs_ip/MacAddress.md"}');
const _sfc_main = { name: "api/package-ribs_ip_ribs_ip/MacAddress.md" };
const _hoisted_1 = {
  id: "macaddress",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("MacAddress ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#macaddress",
        "aria-label": 'Permalink to "MacAddress <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
    ...
    createBaseVNode("h3", _hoisted_4, [
      _cache[11] || (_cache[11] = createTextVNode("compareTo() ", -1)),
      createVNode(_component_Badge, {
        type: "info",
        text: "override"
      }),
    ...
    _cache[39] || (_cache[39] = createStaticVNode("", 16)),
    ...
    _cache[45] || (_cache[45] = createStaticVNode("", 16))
  ]);
}
const MacAddress = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
