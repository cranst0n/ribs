...
const __pageData = JSON.parse('{"title":"IOFiberTrace","description":"API documentation for IOFiberTrace class from ribs_effect","frontmatter":{"title":"IOFiberTrace","description":"API documentation for IOFiberTrace class from ribs_effect","category":"Classes","library":"ribs_effect","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_effect_ribs_effect/IOFiberTrace.md","filePath":"api/package-ribs_effect_ribs_effect/IOFiberTrace.md"}');
const _sfc_main = { name: "api/package-ribs_effect_ribs_effect/IOFiberTrace.md" };
const _hoisted_1 = {
  id: "prop-hashcode",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[20] || (_cache[20] = createStaticVNode('<h1 id="iofibertrace" tabindex="-1">IOFiberTrace <a class="header-anchor" href="#iofibertrace" aria-label="Permalink to &quot;IOFiberTrace&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">IOFiberTrace</span> <span class="kw">implements</span> <span class="type">StackTrace</span></code></pre></div><p>A synthetic <a href="https://api.dart.dev/stable/3.11.4/dart-core/StackTrace-class.html" target="_blank" rel="noreferrer">StackTrace</a> composed of <code>IO.traced</code> labels collected during fiber execution.</p><p>When an error occurs and tracing is enabled, the fiber attaches an <a href="/ribs/api/package-ribs_effect_ribs_effect/IOFiberTrace.html">IOFiberTrace</a> to the error&#39;s stack trace so that the logical call chain through <a href="/ribs/api/package-ribs_effect_ribs_effect/IO.html">IO</a> combinators is visible.</p><div class="info custom-block"><p class="custom-block-title">Implemented types</p><ul><li>StackTrace</li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-iofibertrace" tabindex="-1">IOFiberTrace() <a class="header-anchor" href="#ctor-iofibertrace" aria-label="Permalink to &quot;IOFiberTrace() {#ctor-iofibertrace}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">IOFiberTrace</span>(<span class="type">List</span>&lt;<span class="type">String</span>&gt; <span class="param">trace</span>)</code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">IOFiberTrace</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.trace);</span></span></code></pre></div></details><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 10)),
    ...
    createBaseVNode("h3", _hoisted_3, [
      _cache[8] || (_cache[8] = createTextVNode("trace ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
      ...
      _cache[10] || (_cache[10] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-trace",
        "aria-label": 'Permalink to "trace <Badge type="tip" text="final" /> {#prop-trace}"'
      }, "​", -1))
    ]),
    _cache[23] || (_cache[23] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">List</span>&lt;<span class="type">String</span>&gt; <span class="fn">trace</span></code></pre></div><p>The ordered list of trace labels, from outermost to innermost.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> List</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt; trace;</span></span></code></pre></div></details><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
...
const IOFiberTrace = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  IOFiberTrace as default
};
