...
const __pageData = JSON.parse('{"title":"MetricSystem","description":"API documentation for MetricSystem class from ribs_units","frontmatter":{"title":"MetricSystem","description":"API documentation for MetricSystem class from ribs_units","category":"Classes","library":"ribs_units","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_units_ribs_units/MetricSystem.md","filePath":"api/package-ribs_units_ribs_units/MetricSystem.md"}');
const _sfc_main = { name: "api/package-ribs_units_ribs_units/MetricSystem.md" };
const _hoisted_1 = {
  id: "metricsystem",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("MetricSystem ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#metricsystem",
        "aria-label": 'Permalink to "MetricSystem <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
    ...
    _cache[25] || (_cache[25] = createStaticVNode("", 90))
  ]);
}
const MetricSystem = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  MetricSystem as default
};
