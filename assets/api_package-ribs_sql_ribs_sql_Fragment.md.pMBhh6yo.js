...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[39] || (_cache[39] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./StatementParameters" class="type-link">StatementParameters</a> <span class="fn">params</span></code></pre></div><p>The encoded parameter values corresponding to each <code>?</code> in <a href="/ribs/api/package-ribs_sql_ribs_sql/Fragment.html#prop-sql">sql</a>.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> StatementParameters</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> params;</span></span></code></pre></div></details>', 3)),
    ...
    _cache[41] || (_cache[41] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">String</span> <span class="fn">sql</span></code></pre></div><p>The raw SQL string, with <code>?</code> placeholders for any bound parameters.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> sql;</span></span></code></pre></div></details><h2 id="extension-section-properties" tabindex="-1">Extension Properties <a class="header-anchor" href="#extension-section-properties" aria-label="Permalink to &quot;Extension Properties {#extension-section-properties}&quot;">​</a></h2>', 4)),
