...
const __pageData = JSON.parse('{"title":"Void","description":"API documentation for Void<A> class from ribs_parse","frontmatter":{"title":"Void<A>","description":"API documentation for Void<A> class from ribs_parse","category":"Classes","library":"ribs_parse","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_parse_ribs_parse/Void.md","filePath":"api/package-ribs_parse_ribs_parse/Void.md"}');
const _sfc_main = { name: "api/package-ribs_parse_ribs_parse/Void.md" };
const _hoisted_1 = {
  id: "void-a",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Void<A> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#void-a",
        "aria-label": 'Permalink to "Void\\<A\\> <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
    _cache[140] || (_cache[140] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">Void</span>&lt;A&gt; <span class="kw">extends</span> <a href="./Parser" class="type-link">Parser</a>&lt;<a href="../package-ribs_core_ribs_core/Unit" class="type-link">Unit</a>&gt;</code></pre></div><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser0.html">Parser0&lt;A&gt;</a> → <a href="/ribs/api/package-ribs_parse_ribs_parse/Parser.html">Parser&lt;A&gt;</a> → <strong>Void&lt;A&gt;</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-void" tabindex="-1">Void() <a class="header-anchor" href="#ctor-void" aria-label="Permalink to &quot;Void() {#ctor-void}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">Void</span>(<a href="./Parser" class="type-link">Parser</a>&lt;<span class="type">A</span>&gt; <span class="param">parser</span>)</code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Void</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.parser);</span></span></code></pre></div></details><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 7)),
