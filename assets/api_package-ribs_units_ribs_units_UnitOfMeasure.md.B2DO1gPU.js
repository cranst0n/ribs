...
const __pageData = JSON.parse('{"title":"UnitOfMeasure<A extends Quantity>","description":"API documentation for UnitOfMeasure<A extends Quantity<A>> class from ribs_units","frontmatter":{"title":"UnitOfMeasure<A extends Quantity<A>>","description":"API documentation for UnitOfMeasure<A extends Quantity<A>> class from ribs_units","category":"Classes","library":"ribs_units","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_units_ribs_units/UnitOfMeasure.md","filePath":"api/package-ribs_units_ribs_units/UnitOfMeasure.md"}');
const _sfc_main = { name: "api/package-ribs_units_ribs_units/UnitOfMeasure.md" };
const _hoisted_1 = {
  id: "unitofmeasure-a-extends-quantity-a",
  tabindex: "-1"
};
const _hoisted_2 = {
  id: "ctor-unitofmeasure",
  tabindex: "-1"
};
const _hoisted_3 = {
  id: "prop-hashcode",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("UnitOfMeasure<A extends Quantity<A>> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#unitofmeasure-a-extends-quantity-a",
        "aria-label": 'Permalink to "UnitOfMeasure\\<A extends Quantity\\<A\\>\\> <Badge type="info" text="abstract" />"'
      }, "​", -1))
    ]),
    _cache[29] || (_cache[29] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">class</span> <span class="fn">UnitOfMeasure</span>&lt;A <span class="kw">extends</span> <a href="./Quantity" class="type-link">Quantity</a>&lt;<span class="type">A</span>&gt;&gt;</code></pre></div><p>Abstract base for all units of measure.</p><p>A <a href="/ribs/api/package-ribs_units_ribs_units/UnitOfMeasure.html">UnitOfMeasure</a> knows how to:</p><ul><li>Construct a <a href="/ribs/api/package-ribs_units_ribs_units/Quantity.html">Quantity</a> of type <code>A</code> via <a href="/ribs/api/package-ribs_units_ribs_units/UnitOfMeasure.html#call">call</a>.</li><li>Report its canonical <a href="/ribs/api/package-ribs_units_ribs_units/UnitOfMeasure.html#prop-unit">unit</a> name and display <a href="/ribs/api/package-ribs_units_ribs_units/UnitOfMeasure.html#prop-symbol">symbol</a>.</li><li>Convert a raw value <em>from</em> this unit into a common internal base (<a href="/ribs/api/package-ribs_units_ribs_units/UnitOfMeasure.html#converterfrom">converterFrom</a>) and <em>to</em> this unit from that base (<a href="/ribs/api/package-ribs_units_ribs_units/UnitOfMeasure.html#converterto">converterTo</a>).</li></ul><p>The internal base is chosen per quantity type (e.g. meters for <a href="/ribs/api/package-ribs_units_ribs_units/Length.html">Length</a>, milliseconds for <a href="/ribs/api/package-ribs_units_ribs_units/Time.html">Time</a>) and is never exposed directly to callers.</p><div class="info custom-block"><p class="custom-block-title">Implementers</p><ul><li><a href="/ribs/api/package-ribs_units_ribs_units/TemperatureScale.html">TemperatureScale</a></li><li><a href="/ribs/api/package-ribs_units_ribs_units/UnitConverter.html">UnitConverter&lt;A extends Quantity&lt;A&gt;&gt;</a></li></ul></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 7)),
    createBaseVNode("h3", _hoisted_2, [
      _cache[3] || (_cache[3] = createTextVNode("UnitOfMeasure() ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "const"
      }),
      ...
      _cache[5] || (_cache[5] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#ctor-unitofmeasure",
        "aria-label": 'Permalink to "UnitOfMeasure() <Badge type="tip" text="const" /> {#ctor-unitofmeasure}"'
      }, "​", -1))
    ]),
    _cache[30] || (_cache[30] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">const</span> <span class="fn">UnitOfMeasure</span>()</code></pre></div><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> UnitOfMeasure</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></details><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 3)),
    ...
    createBaseVNode("h3", _hoisted_5, [
      ...
      _cache[16] || (_cache[16] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#prop-symbol",
        "aria-label": 'Permalink to "symbol <Badge type="tip" text="no setter" /> {#prop-symbol}"'
      }, "​", -1))
    ]),
    _cache[33] || (_cache[33] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">String</span> <span class="kw">get</span> <span class="fn">symbol</span></code></pre></div><p>The display symbol for this unit (e.g. <code>&#39;m&#39;</code>, <code>&#39;kg&#39;</code>).</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">String</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> symbol;</span></span></code></pre></div></details>', 3)),
    ...
    _cache[34] || (_cache[34] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">String</span> <span class="kw">get</span> <span class="fn">unit</span></code></pre></div><p>The canonical name of this unit (e.g. <code>&#39;meter&#39;</code>, <code>&#39;kilogram&#39;</code>).</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">String</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> get</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> unit;</span></span></code></pre></div></details><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2><h3 id="call" tabindex="-1">call() <a class="header-anchor" href="#call" aria-label="Permalink to &quot;call() {#call}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="type">A</span> <span class="fn">call</span>(<span class="type">num</span> <span class="param">value</span>)</code></pre></div><p>Creates a quantity of <code>value</code> expressed in this unit.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">A</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> call</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">num</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> value);</span></span></code></pre></div></details><h3 id="converterfrom" tabindex="-1">converterFrom() <a class="header-anchor" href="#converterfrom" aria-label="Permalink to &quot;converterFrom() {#converterfrom}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="type">double</span> <span class="fn">converterFrom</span>(<span class="type">double</span> <span class="param">value</span>)</code></pre></div><p>Converts <code>value</code> expressed in this unit to the internal base value.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">double</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> converterFrom</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">double</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> value);</span></span></code></pre></div></details><h3 id="converterto" tabindex="-1">converterTo() <a class="header-anchor" href="#converterto" aria-label="Permalink to &quot;converterTo() {#converterto}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="type">double</span> <span class="fn">converterTo</span>(<span class="type">double</span> <span class="param">value</span>)</code></pre></div><p>Converts <code>value</code> expressed in the internal base to this unit.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">double</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> converterTo</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">double</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> value);</span></span></code></pre></div></details><h3 id="convertfrom" tabindex="-1">convertFrom() <a class="header-anchor" href="#convertfrom" aria-label="Permalink to &quot;convertFrom() {#convertfrom}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="type">double</span> <span class="fn">convertFrom</span>(<span class="type">num</span> <span class="param">value</span>)</code></pre></div><p>Convenience wrapper: converts <code>value</code> in this unit to the internal base.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">double</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> convertFrom</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">num</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> value) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> converterFrom</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(value.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">toDouble</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">());</span></span></code></pre></div></details><h3 id="convertto" tabindex="-1">convertTo() <a class="header-anchor" href="#convertto" aria-label="Permalink to &quot;convertTo() {#convertto}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="type">double</span> <span class="fn">convertTo</span>(<span class="type">num</span> <span class="param">value</span>)</code></pre></div><p>Convenience wrapper: converts <code>value</code> to this unit&#39;s representation from the internal base.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">double</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> convertTo</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">num</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> value) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> converterTo</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(value.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">toDouble</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">());</span></span></code></pre></div></details>', 24)),
...
const UnitOfMeasure = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  UnitOfMeasure as default
};
