...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createStaticVNode('<h1 id="riterabletuple2ops-a-b" tabindex="-1">RIterableTuple2Ops&lt;A, B&gt; <a class="header-anchor" href="#riterabletuple2ops-a-b" aria-label="Permalink to &quot;RIterableTuple2Ops\\&lt;A, B\\&gt;&quot;">​</a></h1><div class="member-signature"><div class="member-signature-code" data-signature-normalized="true"><span class="member-signature-line"><span class="member-signature-token"><span class="kw">extension</span></span><span class="member-signature-space"></span><span class="member-signature-token"><span class="fn">RIterableTuple2Ops</span></span><span class="member-signature-token">&lt;A, B&gt;</span><span class="member-signature-space"></span><span class="member-signature-token"><span class="kw">on</span></span><span class="member-signature-space"></span><span class="member-signature-token"><a href="./RIterable" class="type-link">RIterable</a></span><span class="member-signature-token">&lt;</span><span class="member-signature-token"><span class="type">Record</span></span><span class="member-signature-token">&gt;</span></span></div></div><p>Conversion operations for <a href="/ribs/api/package-ribs_core_ribs_core/RIterable.html">RIterable</a> of 2-tuples.</p><h2 id="section-methods" tabindex="-1">Methods <a class="header-anchor" href="#section-methods" aria-label="Permalink to &quot;Methods {#section-methods}&quot;">​</a></h2>', 4)),
