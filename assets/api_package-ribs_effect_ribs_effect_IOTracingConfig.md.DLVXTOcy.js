...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[23] || (_cache[23] = createStaticVNode('<h1 id="iotracingconfig" tabindex="-1">IOTracingConfig <a class="header-anchor" href="#iotracingconfig" aria-label="Permalink to &quot;IOTracingConfig&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">IOTracingConfig</span></code></pre></div><p>Global configuration for IO fiber tracing.</p><p>When <a href="/ribs/api/package-ribs_effect_ribs_effect/IOTracingConfig.html#prop-tracingenabled">tracingEnabled</a> is <code>true</code>, the interpreter records a ring buffer of labeled trace entries for each fiber. This is useful for debugging complex async programs but adds overhead and should be disabled in production.</p><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-iotracingconfig" tabindex="-1">IOTracingConfig() <a class="header-anchor" href="#ctor-iotracingconfig" aria-label="Permalink to &quot;IOTracingConfig() {#ctor-iotracingconfig}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">IOTracingConfig</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 8)),
    ...
    _cache[29] || (_cache[29] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">int</span> <span class="fn">traceBufferSize</span></code></pre></div><p><strong>getter:</strong></p><p>The maximum number of trace entries retained per fiber.</p><p><strong>setter:</strong></p><p>The maximum number of trace entries retained per fiber.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> int</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> traceBufferSize </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 64</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre></div></details>', 6)),
    ...
    _cache[30] || (_cache[30] = createStaticVNode('<div class="member-signature"><pre><code><span class="type">bool</span> <span class="fn">tracingEnabled</span></code></pre></div><p><strong>getter:</strong></p><p>Whether tracing is currently enabled. Defaults to <code>false</code>.</p><p><strong>setter:</strong></p><p>Whether tracing is currently enabled. Defaults to <code>false</code>.</p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">static</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> bool</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> tracingEnabled </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> false</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre></div></details>', 6))
  ]);
}
