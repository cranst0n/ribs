...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[20] || (_cache[20] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <span class="kw">class</span> <span class="fn">MissingField</span> <span class="kw">extends</span> <a href="./Reason" class="type-link">Reason</a></code></pre></div><p>Indicates that a required field was absent from the JSON object.</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_json_ribs_json/Reason.html">Reason</a> → <strong>MissingField</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2><h3 id="ctor-missingfield" tabindex="-1">MissingField() <a class="header-anchor" href="#ctor-missingfield" aria-label="Permalink to &quot;MissingField() {#ctor-missingfield}&quot;">​</a></h3><div class="member-signature"><pre><code><span class="fn">MissingField</span>()</code></pre></div><h2 id="section-properties" tabindex="-1">Properties <a class="header-anchor" href="#section-properties" aria-label="Permalink to &quot;Properties {#section-properties}&quot;">​</a></h2>', 7)),
