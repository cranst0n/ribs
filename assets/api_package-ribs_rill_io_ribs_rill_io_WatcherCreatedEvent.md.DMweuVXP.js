...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[24] || (_cache[24] = createStaticVNode('<h1 id="watchercreatedevent" tabindex="-1">WatcherCreatedEvent <a class="header-anchor" href="#watchercreatedevent" aria-label="Permalink to &quot;WatcherCreatedEvent&quot;">​</a></h1><div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">WatcherCreatedEvent</span> <span class="kw">extends</span> <a href="./WatcherEvent" class="type-link">WatcherEvent</a></code></pre></div><p>Emitted when a new file or directory is created at <a href="/ribs/api/package-ribs_rill_io_ribs_rill_io/WatcherEvent.html#prop-path">path</a>.</p><div class="info custom-block"><p class="custom-block-title">Inheritance</p><p>Object → <a href="/ribs/api/package-ribs_rill_io_ribs_rill_io/WatcherEvent.html">WatcherEvent</a> → <strong>WatcherCreatedEvent</strong></p></div><h2 id="section-constructors" tabindex="-1">Constructors <a class="header-anchor" href="#section-constructors" aria-label="Permalink to &quot;Constructors {#section-constructors}&quot;">​</a></h2>', 5)),
    ...
    _cache[27] || (_cache[27] = createStaticVNode('<div class="member-signature"><pre><code><span class="kw">final</span> <a href="./Path" class="type-link">Path</a> <span class="fn">path</span></code></pre></div><p>The path of the filesystem entry that triggered this event.</p><p><em>Inherited from WatcherEvent.</em></p><details class="details custom-block"><summary>Implementation</summary><div class="language-dart vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">final</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Path</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> path;</span></span></code></pre></div></details>', 4)),
