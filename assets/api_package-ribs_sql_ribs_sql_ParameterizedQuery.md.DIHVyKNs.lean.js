...
const __pageData = JSON.parse('{"title":"ParameterizedQuery<P, A>","description":"API documentation for ParameterizedQuery<P, A> class from ribs_sql","frontmatter":{"title":"ParameterizedQuery<P, A>","description":"API documentation for ParameterizedQuery<P, A> class from ribs_sql","category":"Classes","library":"ribs_sql","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_sql_ribs_sql/ParameterizedQuery.md","filePath":"api/package-ribs_sql_ribs_sql/ParameterizedQuery.md"}');
const _sfc_main = { name: "api/package-ribs_sql_ribs_sql/ParameterizedQuery.md" };
const _hoisted_1 = {
  id: "parameterizedquery-p-a",
  tabindex: "-1"
};
const _hoisted_2 = {
  id: "ctor-parameterizedquery",
  tabindex: "-1"
};
const _hoisted_3 = {
  id: "prop-hashcode",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("h1", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("ParameterizedQuery<P, A> ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#parameterizedquery-p-a",
        "aria-label": 'Permalink to "ParameterizedQuery\\<P, A\\> <Badge type="info" text="final" />"'
      }, "​", -1))
    ]),
    _cache[32] || (_cache[32] = createStaticVNode("", 5)),
    createBaseVNode("h3", _hoisted_2, [
      _cache[3] || (_cache[3] = createTextVNode("ParameterizedQuery() ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "const"
      }),
      ...
      _cache[5] || (_cache[5] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#ctor-parameterizedquery",
        "aria-label": 'Permalink to "ParameterizedQuery() <Badge type="tip" text="const" /> {#ctor-parameterizedquery}"'
      }, "​", -1))
    ]),
    ...
    createBaseVNode("h3", _hoisted_4, [
      _cache[10] || (_cache[10] = createTextVNode("read ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
    ...
    createBaseVNode("h3", _hoisted_7, [
      _cache[20] || (_cache[20] = createTextVNode("write ", -1)),
      createVNode(_component_Badge, {
        type: "tip",
        text: "final"
      }),
    ...
    _cache[39] || (_cache[39] = createStaticVNode("", 24)),
    ...
    _cache[40] || (_cache[40] = createStaticVNode("", 11)),
...
const ParameterizedQuery = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  ParameterizedQuery as default
};
