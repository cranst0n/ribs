...
const __pageData = JSON.parse('{"title":"Cookie","description":"API documentation for Cookie class from ribs_http","frontmatter":{"title":"Cookie","description":"API documentation for Cookie class from ribs_http","category":"Classes","library":"ribs_http","outline":[2,3],"editLink":false,"prev":false,"next":false},"headers":[],"relativePath":"api/package-ribs_http_ribs_http/Cookie.md","filePath":"api/package-ribs_http_ribs_http/Cookie.md"}');
const _sfc_main = { name: "api/package-ribs_http_ribs_http/Cookie.md" };
const _hoisted_1 = {
  id: "ctor-cookie",
  tabindex: "-1"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("h3", _hoisted_1, [
      _cache[0] || (_cache[0] = createTextVNode("Cookie() ", -1)),
      ...
      _cache[2] || (_cache[2] = createBaseVNode("a", {
        class: "header-anchor",
        href: "#ctor-cookie",
        "aria-label": 'Permalink to "Cookie() <Badge type="tip" text="factory" /> {#ctor-cookie}"'
      }, "​", -1))
    ]),
