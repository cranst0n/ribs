...
Gen<(String, Json)> genObjElem(int depth) => Gen.alphaNumString(10)
    .flatMap((key) => genJsonAtDepth(depth - 1).map((value) => (key, value)));

Gen<JsonObject> genObject(int depth) =>
    Gen.listOf(Gen.chooseInt(0, _maxObjectSize), genObjElem(depth))
