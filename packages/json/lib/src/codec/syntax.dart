...
extension Codec4KVOps<A, B, C, D> on (
  KeyValueCodec<A>,
  KeyValueCodec<B>,
  KeyValueCodec<C>,
  KeyValueCodec<D>
...
extension Codec4Ops<A, B, C, D> on (
  (String, Codec<A>),
  (String, Codec<B>),
  (String, Codec<C>),
  (String, Codec<D>)
...
extension Codec5KVOps<A, B, C, D, E> on (
  KeyValueCodec<A>,
  KeyValueCodec<B>,
  KeyValueCodec<C>,
  KeyValueCodec<D>,
...
extension Codec5Ops<A, B, C, D, E> on (
  (String, Codec<A>),
  (String, Codec<B>),
  (String, Codec<C>),
  (String, Codec<D>),
...
extension Codec6KVOps<A, B, C, D, E, F> on (
  KeyValueCodec<A>,
  KeyValueCodec<B>,
  KeyValueCodec<C>,
  KeyValueCodec<D>,
...
extension Codec7KVOps<A, B, C, D, E, F, G> on (
  KeyValueCodec<A>,
  KeyValueCodec<B>,
  KeyValueCodec<C>,
  KeyValueCodec<D>,
...
extension Codec8KVOps<A, B, C, D, E, F, G, H> on (
  KeyValueCodec<A>,
  KeyValueCodec<B>,
  KeyValueCodec<C>,
  KeyValueCodec<D>,
...
extension Codec10Ops<A, B, C, D, E, F, G, H, I, J> on (
  ...
  Codec<K> product<K>(
    ...
    Function1<K, (A, B, C, D, E, F, G, H, I, J)> tupled,
      ...
      ($1.kv, $2.kv, $3.kv, $4.kv, $5.kv, $6.kv, $7.kv, $8.kv, $9.kv, $10.kv)
          .product(apply, tupled);
}

extension Codec11KVOps<A, B, C, D, E, F, G, H, I, J, K> on (
  KeyValueCodec<A>,
  KeyValueCodec<B>,
  KeyValueCodec<C>,
  KeyValueCodec<D>,
...
extension Codec14KVOps<A, B, C, D, E, F, G, H, I, J, K, L, M, N> on (
  KeyValueCodec<A>,
  KeyValueCodec<B>,
  KeyValueCodec<C>,
  KeyValueCodec<D>,
...
extension Codec15KVOps<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> on (
  KeyValueCodec<A>,
  KeyValueCodec<B>,
  KeyValueCodec<C>,
  KeyValueCodec<D>,
...
extension Codec16KVOps<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> on (
  KeyValueCodec<A>,
  KeyValueCodec<B>,
  KeyValueCodec<C>,
  KeyValueCodec<D>,
...
extension Codec17KVOps<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q> on (
  KeyValueCodec<A>,
  KeyValueCodec<B>,
  KeyValueCodec<C>,
  KeyValueCodec<D>,
