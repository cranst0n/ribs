...
abstract class CursorOp {
  ...
  static CursorOp get deleteGoParent => DeleteGoParent();
  static CursorOp get downArray => DownArray();
  static CursorOp downField(String k) => DownField(k);
  static CursorOp downN(int n) => DownN(n);
  static CursorOp get moveLeft => MoveLeft();
  static CursorOp get moveRight => MoveRight();
  static CursorOp get moveUp => MoveUp();
