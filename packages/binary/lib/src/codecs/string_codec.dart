...
final class StringCodec {
  static Codec<String> acsii() {
    final encoder =
        Encoder.instance((String s) => Either.right(ByteVector(convert.ascii.encode(s)).bits));
  ...
  static Codec<String> utf8() {
    final encoder =
        Encoder.instance((String s) => Either.right(ByteVector(convert.utf8.encode(s)).bits));
