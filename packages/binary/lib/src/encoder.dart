...
abstract mixin class Encoder<A> {
  ...
  static Encoder<(A, B, C)> tuple3<A, B, C>(
    ...
    Encoder<C> encodeC,
      ...
      _EncoderF((tuple) => tuple2(encodeA, encodeB)
          .encode(tuple.init())
          .flatMap((a) => encodeC.encode(tuple.last).map(a.concat)));
  ...
  static Encoder<(A, B, C, D)> tuple4<A, B, C, D>(
    ...
    Encoder<D> encodeD,
      ...
      _EncoderF((tuple) => tuple3(encodeA, encodeB, encodeC)
          .encode(tuple.init())
          .flatMap((a) => encodeD.encode(tuple.last).map(a.concat)));
  ...
  static Encoder<(A, B, C, D, E)> tuple5<A, B, C, D, E>(
    ...
    Encoder<E> encodeE,
      ...
      _EncoderF((tuple) => tuple4(encodeA, encodeB, encodeC, encodeD)
          .encode(tuple.init())
          .flatMap((a) => encodeE.encode(tuple.last).map(a.concat)));
  ...
  static Encoder<(A, B, C, D, E, F)> tuple6<A, B, C, D, E, F>(
    ...
    Encoder<F> encodeF,
      ...
      _EncoderF((tuple) => tuple5(encodeA, encodeB, encodeC, encodeD, encodeE)
          .encode(tuple.init())
          .flatMap((a) => encodeF.encode(tuple.last).map(a.concat)));
  ...
  static Encoder<(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q)>
    ...
    Encoder<Q> encodeQ,
          ...
          _EncoderF((tuple) => tuple16(
                  ...
                  encodeP)
              .encode(tuple.init())
              .flatMap((a) => encodeQ.encode(tuple.last).map(a.concat)));
  ...
  static Encoder<(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R)>
    ...
    Encoder<R> encodeR,
          ...
          _EncoderF((tuple) => tuple17(
                  ...
                  encodeQ)
              .encode(tuple.init())
              .flatMap((a) => encodeR.encode(tuple.last).map(a.concat)));
  ...
  static Encoder<(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R, S)>
    ...
    Encoder<S> encodeS,
          ...
          _EncoderF((tuple) => tuple18(
                  ...
                  encodeR)
              .encode(tuple.init())
              .flatMap((a) => encodeS.encode(tuple.last).map(a.concat)));
  ...
  static Encoder<
    ...
    Encoder<V> encodeV,
          ...
          _EncoderF((tuple) => tuple21(
                  ...
                  encodeU)
              .encode(tuple.init())
              .flatMap((a) => encodeV.encode(tuple.last).map(a.concat)));
}
