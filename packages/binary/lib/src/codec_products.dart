...
extension Codec6Ops<A, B, C, D, E, F>
    on (Codec<A>, Codec<B>, Codec<C>, Codec<D>, Codec<E>, Codec<F>) {
  Codec<G> product<G>(
...
extension Codec7Ops<A, B, C, D, E, F, G>
    on (Codec<A>, Codec<B>, Codec<C>, Codec<D>, Codec<E>, Codec<F>, Codec<G>) {
  Codec<H> product<H>(
...
extension Codec8Ops<A, B, C, D, E, F, G, H>
    on (Codec<A>, Codec<B>, Codec<C>, Codec<D>, Codec<E>, Codec<F>, Codec<G>, Codec<H>) {
  Codec<I> product<I>(
...
extension Codec9Ops<A, B, C, D, E, F, G, H, I>
    on (Codec<A>, Codec<B>, Codec<C>, Codec<D>, Codec<E>, Codec<F>, Codec<G>, Codec<H>, Codec<I>) {
  Codec<J> product<J>(
