...
abstract class BitVector {
  ...
  Uint8List get toByteArray => toByteVector.toByteArray;
  ...
  BitVector invertReverseByteOrder() {
    if (size % 8 == 0) {
      ...
      return initAndLast.$2.concat(initAndLast.$1.toByteVector.reverse.bits);
    }
  }
  ...
  String get toBinString => toByteVector.toBinString.substring(0, size);

  String get toHexString => toByteVector.toHexString;
...
class Bytes extends BitVector {
  ...
  @override
  ByteVector get toByteVector => _underlying;
...
class Drop extends BitVector {
  ...
  @override
  ByteVector get toByteVector => interpretDrop().toByteVector;
