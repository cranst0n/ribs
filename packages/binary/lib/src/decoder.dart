...
abstract mixin class Decoder<A> {
  ...
  static Decoder<(A, B)> tuple2<A, B>(
    ...
    Decoder<B> decodeB,
      ...
      _DecoderF((bv) => decodeA.decode(bv).flatMap((a) =>
  ...
  static Decoder<(A, B, C)> tuple3<A, B, C>(
    ...
    Decoder<C> decodeC,
      ...
      _DecoderF((bv) => tuple2(decodeA, decodeB).decode(bv).flatMap((t) => decodeC
          .decode(t.remainder)
  ...
  static Decoder<(A, B, C, D)> tuple4<A, B, C, D>(
    ...
    Decoder<D> decodeD,
      ...
      _DecoderF((bv) => tuple3(decodeA, decodeB, decodeC).decode(bv).flatMap((t) => decodeD
          .decode(t.remainder)
  ...
  static Decoder<(A, B, C, D, E)> tuple5<A, B, C, D, E>(
    ...
    Decoder<E> decodeE,
      ...
      _DecoderF((bv) => tuple4(decodeA, decodeB, decodeC, decodeD).decode(bv).flatMap((t) => decodeE
          .decode(t.remainder)
  ...
  static Decoder<(A, B, C, D, E, F)> tuple6<A, B, C, D, E, F>(
    ...
    Decoder<F> decodeF,
      ...
      _DecoderF((bv) => tuple5(decodeA, decodeB, decodeC, decodeD, decodeE).decode(bv).flatMap(
          (t) => decodeF
              .decode(t.remainder)
  ...
  static Decoder<(A, B, C, D, E, F, G)> tuple7<A, B, C, D, E, F, G>(
    ...
    Decoder<G> decodeG,
      ...
      _DecoderF((bv) => tuple6(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF)
          .decode(bv)
          .flatMap((t) => decodeG
              .decode(t.remainder)
  ...
  static Decoder<(A, B, C, D, E, F, G, H)> tuple8<A, B, C, D, E, F, G, H>(
    ...
    Decoder<H> decodeH,
      ...
      _DecoderF((bv) => tuple7(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF, decodeG)
          .decode(bv)
          .flatMap((t) => decodeH
              .decode(t.remainder)
  ...
  static Decoder<(A, B, C, D, E, F, G, H, I)> tuple9<A, B, C, D, E, F, G, H, I>(
    ...
    Decoder<I> decodeI,
      ...
      _DecoderF((bv) =>
          tuple8(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF, decodeG, decodeH)
              .decode(bv)
              .flatMap((t) => decodeI
                  .decode(t.remainder)
  ...
  static Decoder<(A, B, C, D, E, F, G, H, I, J)> tuple10<A, B, C, D, E, F, G, H, I, J>(
    ...
    Decoder<J> decodeJ,
      ...
      _DecoderF((bv) =>
          tuple9(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF, decodeG, decodeH, decodeI)
              .decode(bv)
              .flatMap((t) => decodeJ
                  .decode(t.remainder)
  ...
  static Decoder<(A, B, C, D, E, F, G, H, I, J, K)> tuple11<A, B, C, D, E, F, G, H, I, J, K>(
    ...
    Decoder<K> decodeK,
      ...
      _DecoderF((bv) => tuple10(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF, decodeG,
  ...
  static Decoder<(A, B, C, D, E, F, G, H, I, J, K, L)> tuple12<A, B, C, D, E, F, G, H, I, J, K, L>(
    ...
    Decoder<L> decodeL,
      ...
      _DecoderF((bv) => tuple11(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF, decodeG,
  ...
  static Decoder<(A, B, C, D, E, F, G, H, I, J, K, L, M)>
    ...
    Decoder<M> decodeM,
          ...
          _DecoderF((bv) => tuple12(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF, decodeG,
  ...
  static Decoder<(A, B, C, D, E, F, G, H, I, J, K, L, M, N)>
    ...
    Decoder<N> decodeN,
          ...
          _DecoderF((bv) => tuple13(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF, decodeG,
  ...
  static Decoder<(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O)>
    ...
    Decoder<O> decodeO,
          ...
          _DecoderF((bv) => tuple14(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF, decodeG,
  ...
  static Decoder<(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P)>
    ...
    Decoder<P> decodeP,
          ...
          _DecoderF((bv) => tuple15(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF, decodeG,
                  decodeH, decodeI, decodeJ, decodeK, decodeL, decodeM, decodeN, decodeO)
              .decode(bv)
              .flatMap((t) => decodeP
                  .decode(t.remainder)
  ...
  static Decoder<(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q)>
    ...
    Decoder<Q> decodeQ,
          ...
          _DecoderF((bv) => tuple16(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF, decodeG,
                  decodeH, decodeI, decodeJ, decodeK, decodeL, decodeM, decodeN, decodeO, decodeP)
              .decode(bv)
              .flatMap((t) => decodeQ
                  .decode(t.remainder)
