...
class NonEmptyIList<A> implements Monad<A>, Foldable<A> {
  ...
  IList<A> get distinct => toIList.distinct;
  ...
  @override
  B foldRight<B>(B init, Function2<A, B, B> op) => toIList.foldRight(init, op);
  ...
  NonEmptyIList<A> get reverse => tail.isEmpty
      ? this
  ...
  IList<A> get toIList => Cons(head, tail);

  List<A> get toList => toIList.toList;
