...
abstract class Validated<E, A> implements Functor<A> {
  ...
  Validated<A, E> get swap => fold((e) => e.valid(), (a) => a.invalid());

  Either<E, A> get toEither => fold((e) => e.asLeft(), (a) => a.asRight());

  IList<A> get toIList => fold((_) => nil(), (a) => IList.of([a]));

  Option<A> get toOption => fold((_) => none(), (a) => a.some);
