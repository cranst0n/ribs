...
class DartMapGetBenchmark extends BenchmarkBase {
  ...
  DartMapGetBenchmark(this.n) : super('dart-map-get-$n', emitter: RibsBenchmarkEmitter());
...
class FICIMapGetBenchmark extends BenchmarkBase {
  ...
  FICIMapGetBenchmark(this.n) : super('fic-imap-get-$n', emitter: RibsBenchmarkEmitter());
...
class RibsIMapGetBenchmark extends BenchmarkBase {
  ...
  RibsIMapGetBenchmark(this.n) : super('ribs-imap-get-$n', emitter: RibsBenchmarkEmitter());
...
class RibsMMapGetBenchmark extends BenchmarkBase {
  ...
  RibsMMapGetBenchmark(this.n) : super('ribs-mmap-get-$n', emitter: RibsBenchmarkEmitter());
...
class DartzIMapGetBenchmark extends BenchmarkBase {
  ...
  DartzIMapGetBenchmark(this.n) : super('dartz-imap-get-$n', emitter: RibsBenchmarkEmitter());
...
class BuiltMapGetBenchmark extends BenchmarkBase {
  ...
  BuiltMapGetBenchmark(this.n) : super('built-map-get-$n', emitter: RibsBenchmarkEmitter());
...
class KtMapGetBenchmark extends BenchmarkBase {
  ...
  KtMapGetBenchmark(this.n) : super('kt-map-get-$n', emitter: RibsBenchmarkEmitter());
