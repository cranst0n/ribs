...
class DartMapRemovePresentBenchmark extends BenchmarkBase {
  ...
  DartMapRemovePresentBenchmark(this.n) : super('dart-map-remove-present-$n');
...
class FICIMapRemovePresentBenchmark extends BenchmarkBase {
  ...
  FICIMapRemovePresentBenchmark(this.n) : super('fic-imap-remove-present-$n');
...
class RibsIMapRemovePresentBenchmark extends BenchmarkBase {
  ...
  RibsIMapRemovePresentBenchmark(this.n) : super('ribs-imap-remove-present-$n');
...
class RibsMMapRemovePresentBenchmark extends BenchmarkBase {
  ...
  RibsMMapRemovePresentBenchmark(this.n) : super('ribs-mmap-remove-present-$n');
...
class DartzIMapRemovePresentBenchmark extends BenchmarkBase {
  ...
  DartzIMapRemovePresentBenchmark(this.n) : super('dartz-imap-remove-present-$n');
...
class BuiltMapRemovePresentBenchmark extends BenchmarkBase {
  ...
  BuiltMapRemovePresentBenchmark(this.n) : super('built-map-remove-present-$n');
...
class KtMapRemovePresentBenchmark extends BenchmarkBase {
  ...
  KtMapRemovePresentBenchmark(this.n) : super('kt-map-remove-present-$n');
