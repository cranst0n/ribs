...
class DartSetRemoveBenchmark extends BenchmarkBase {
  ...
  DartSetRemoveBenchmark(this.n) : super('dart-set-remove-$n', emitter: RibsBenchmarkEmitter());
...
class DartzISetRemoveBenchmark extends BenchmarkBase {
  ...
  DartzISetRemoveBenchmark(this.n) : super('dartz-iset-remove-$n', emitter: RibsBenchmarkEmitter());
...
class FICISetRemoveBenchmark extends BenchmarkBase {
  ...
  FICISetRemoveBenchmark(this.n) : super('fic-iset-remove-$n', emitter: RibsBenchmarkEmitter());
...
class RibsISetRemoveBenchmark extends BenchmarkBase {
  ...
  RibsISetRemoveBenchmark(this.n) : super('ribs-iset-remove-$n', emitter: RibsBenchmarkEmitter());
...
class RibsMSetRemoveBenchmark extends BenchmarkBase {
  ...
  RibsMSetRemoveBenchmark(this.n) : super('ribs-mset-remove-$n', emitter: RibsBenchmarkEmitter());
