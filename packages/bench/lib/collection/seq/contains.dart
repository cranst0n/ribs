...
class DartListContainsBenchmark extends BenchmarkBase {
  ...
  DartListContainsBenchmark(this.n) : super('dart-list-contains-$n');
...
class BuiltListContainsBenchmark extends BenchmarkBase {
  ...
  BuiltListContainsBenchmark(this.n) : super('built-list-contains-$n');
...
class DartzIListContainsBenchmark extends BenchmarkBase {
  ...
  DartzIListContainsBenchmark(this.n) : super('dartz-ilist-contains-$n');
...
class FICIListContainsBenchmark extends BenchmarkBase {
  ...
  FICIListContainsBenchmark(this.n) : super('fic-ilist-contains-$n');
...
class KtListContainsBenchmark extends BenchmarkBase {
  ...
  KtListContainsBenchmark(this.n) : super('kt-list-contains-$n');
...
class RibsIListContainsBenchmark extends BenchmarkBase {
  ...
  RibsIListContainsBenchmark(this.n) : super('ribs-ilist-contains-$n');
...
class RibsIVectorContainsBenchmark extends BenchmarkBase {
  ...
  RibsIVectorContainsBenchmark(this.n) : super('ribs-ivector-contains-$n');
