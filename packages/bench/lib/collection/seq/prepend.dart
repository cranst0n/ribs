...
class DartListPrependBenchmark extends BenchmarkBase {
  ...
  DartListPrependBenchmark(this.n) : super('dart-list-prepend-$n', emitter: RibsBenchmarkEmitter());
...
class BuiltListPrependBenchmark extends BenchmarkBase {
  ...
  BuiltListPrependBenchmark(this.n)
    : super('built-list-prepend-$n', emitter: RibsBenchmarkEmitter());
...
class DartzIListPrependBenchmark extends BenchmarkBase {
  ...
  DartzIListPrependBenchmark(this.n)
    : super('dartz-ilist-prepend-$n', emitter: RibsBenchmarkEmitter());
...
class FICIListPrependBenchmark extends BenchmarkBase {
  ...
  FICIListPrependBenchmark(this.n) : super('fic-ilist-prepend-$n', emitter: RibsBenchmarkEmitter());
...
class RibsIChainPrependBenchmark extends BenchmarkBase {
  ...
  RibsIChainPrependBenchmark(this.n)
    : super('ribs-ichain-prepend-$n', emitter: RibsBenchmarkEmitter());
...
class RibsIListPrependBenchmark extends BenchmarkBase {
  ...
  RibsIListPrependBenchmark(this.n)
    : super('ribs-ilist-prepend-$n', emitter: RibsBenchmarkEmitter());
...
class RibsIVectorPrependBenchmark extends BenchmarkBase {
  ...
  RibsIVectorPrependBenchmark(this.n)
    : super('ribs-ivector-prepend-$n', emitter: RibsBenchmarkEmitter());
...
class RibsListBufferPrependBenchmark extends BenchmarkBase {
  ...
  RibsListBufferPrependBenchmark(this.n)
    : super('ribs-listbuffer-prepend-$n', emitter: RibsBenchmarkEmitter());
