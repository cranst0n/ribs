...
class DartListInitBenchmark extends BenchmarkBase {
  ...
  DartListInitBenchmark(this.n) : super('dart-list-init-$n');
...
class BuiltListInitBenchmark extends BenchmarkBase {
  ...
  BuiltListInitBenchmark(this.n) : super('built-list-init-$n');
...
class FICIListInitBenchmark extends BenchmarkBase {
  ...
  FICIListInitBenchmark(this.n) : super('fic-ilist-init-$n');
...
class KtListInitBenchmark extends BenchmarkBase {
  ...
  KtListInitBenchmark(this.n) : super('kt-list-init-$n');
...
class RibsIChainInitBenchmark extends BenchmarkBase {
  ...
  RibsIChainInitBenchmark(this.n) : super('ribs-ichain-init-$n');
...
class RibsIListInitBenchmark extends BenchmarkBase {
  ...
  RibsIListInitBenchmark(this.n) : super('ribs-ilist-init-$n');
...
class RibsIVectorInitBenchmark extends BenchmarkBase {
  ...
  RibsIVectorInitBenchmark(this.n) : super('ribs-ivector-init-$n');
