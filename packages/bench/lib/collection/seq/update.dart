...
class DartListUpdateBenchmark extends BenchmarkBase {
  ...
  DartListUpdateBenchmark(this.n) : super('dart-list-update-$n', emitter: RibsBenchmarkEmitter());
...
class BuiltListUpdateBenchmark extends BenchmarkBase {
  ...
  BuiltListUpdateBenchmark(this.n) : super('built-list-update-$n', emitter: RibsBenchmarkEmitter());
...
class FICIListUpdateBenchmark extends BenchmarkBase {
  ...
  FICIListUpdateBenchmark(this.n) : super('fic-ilist-update-$n', emitter: RibsBenchmarkEmitter());
...
class RibsIListUpdateBenchmark extends BenchmarkBase {
  ...
  RibsIListUpdateBenchmark(this.n) : super('ribs-ilist-update-$n', emitter: RibsBenchmarkEmitter());
...
class RibsIVectorUpdateBenchmark extends BenchmarkBase {
  ...
  RibsIVectorUpdateBenchmark(this.n)
    : super('ribs-ivector-update-$n', emitter: RibsBenchmarkEmitter());
...
class RibsListBufferUpdateBenchmark extends BenchmarkBase {
  ...
  RibsListBufferUpdateBenchmark(this.n)
    : super('ribs-listbuffer-update-$n', emitter: RibsBenchmarkEmitter());
