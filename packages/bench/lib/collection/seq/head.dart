...
class DartListHeadBenchmark extends BenchmarkBase {
  ...
  DartListHeadBenchmark(this.n) : super('dart-list-head-$n');
...
class BuiltListHeadBenchmark extends BenchmarkBase {
  ...
  BuiltListHeadBenchmark(this.n) : super('built-list-head-$n');
...
class FICIListHeadBenchmark extends BenchmarkBase {
  ...
  FICIListHeadBenchmark(this.n) : super('fic-ilist-head-$n');
...
class KtListHeadBenchmark extends BenchmarkBase {
  ...
  KtListHeadBenchmark(this.n) : super('kt-list-head-$n');
...
class RibsIChainHeadBenchmark extends BenchmarkBase {
  ...
  RibsIChainHeadBenchmark(this.n) : super('ribs-ichain-head-$n');
...
class RibsIListHeadBenchmark extends BenchmarkBase {
  ...
  RibsIListHeadBenchmark(this.n) : super('ribs-ilist-head-$n');
...
class RibsIVectorHeadBenchmark extends BenchmarkBase {
  ...
  RibsIVectorHeadBenchmark(this.n) : super('ribs-ivector-head-$n');
...
class RibsListBufferHeadBenchmark extends BenchmarkBase {
  ...
  RibsListBufferHeadBenchmark(this.n) : super('ribs-listbuffer-head-$n');
