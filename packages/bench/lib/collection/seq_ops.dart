  ...
  ns.forEach((n) {
    ...
    final benchmarks = [
      ...
      ComparativeBenchmark(
        ...
        'filter',
        () => genBuiltList(n),
        (l) => l.rebuild((p0) => p0.where((x) => x.isOdd)),
        emitter,
      ),
      ComparativeBenchmark(
        'Dartz IList',
      ...
      ComparativeBenchmark(
        ...
        'tail',
        () => genDartzList(n),
        (l) => l.tailOption.getOrElse(() => throw ''),
        emitter,
      ),
      ComparativeBenchmark(
        'FIC IList',
      ...
      ComparativeBenchmark(
        ...
        'fold',
        () => genDartzList(n),
        (l) => tap(l, (l) => l.foldLeft(0, (a, b) => a + b)),
        emitter,
      ),
      ComparativeBenchmark(
        'FIC IList',
