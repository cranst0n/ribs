...
void main(List<String> args) {
  ...
  ns.forEach((n) {
    ...
    final benchmarks = [
      ...
      ComparativeBenchmark('Kt List', 'drop', () => genKtList(n),
      ...
      ComparativeBenchmark('Kt List', 'take', () => genKtList(n),
      ...
      ComparativeBenchmark('Dartz IList', 'concat', () => genDartzList(n),
          (l) => l.plus(l), emitter),
      ComparativeBenchmark('FIC IList', 'concat', () => genFicList(n),
