...
sealed class IO<A> with Functor<A>, Applicative<A>, Monad<A> {
  ...
  IO<A> _handleErrorWith(Function1<Object, IO<A>> f) => _HandleErrorWith(this, Fn2((e, st) => f(e)));
  ...
  IO<A> _onError(Function1<Object, IO<Unit>> f) =>
      _HandleErrorWith(this, Fn2((e, st) => f(e)._attempt()._productR(() => IO._raiseError<A>(e, st))));
