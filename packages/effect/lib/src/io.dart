...
sealed class IO<A> with Functor<A>, Applicative<A>, Monad<A> {
  ...
  /// is canceled, that error or cancelation is propagated.
  ...
  /// Returns an `IO.raiseError` when [cond] is false, otherwise `IO.unit`.
  ...
  /// Returns an `IO.raiseError` when [cond] is true, otherwise `IO.unit`.
  ...
  /// Creates an asynchronous [IO] that will sleep for the given [duration]
