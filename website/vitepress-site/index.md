...
hero:
  name: Ribs
  tagline: First-class functional programming for Dart
  image:
    src: /logo.png
    alt: Ribs
  actions:
...
features:
  - icon: ⚙️
    title: Core
    details: Foundational functional types — Option, Either, Validated, and a full
      immutable collections hierarchy (IList, IMap, ISet, IVector).
  - icon: 🕹️
    title: Effect
  ...
  - icon: 📄
    ...
    details: Type-safe JSON encoding and decoding via composable Codec values.
      Supports cursors, streaming, and schema derivation.
  - icon: 🔟
    title: Binary
    details: Low-level binary encoding and decoding with BitVector and ByteVector.
      Includes built in streaming and CRC support.
  - icon: ⚗️
    title: Check
    details: Property-based testing integrated with dart test. Define generators
      and let the framework find edge cases automatically.
  - icon: 🛢️
    title: SQL
  ...
  - icon: 🔬
    title: Optics
    details: Composable optics — Lens, Prism, Optional, and Iso — for immutable
      data access and transformation deep inside nested structures.
  - icon: 🌐
    title: IP
