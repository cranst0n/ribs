...
import SignalSnippet from '!!raw-loader!../../snippets/lib/src/rill/signal.dart';
...
<CodeSnippet snippet={SignalSnippet} section="signal-basics" />
...
<CodeSnippet snippet={SignalSnippet} section="signal-discrete" />
...
<CodeSnippet snippet={SignalSnippet} section="signal-continuous" />
...
<CodeSnippet snippet={SignalSnippet} section="signal-interrupt" />
...
<CodeSnippet snippet={SignalSnippet} section="signal-realworld" />
