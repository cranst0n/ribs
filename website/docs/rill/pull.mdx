...
import PullSnippet from '!!raw-loader!../../snippets/lib/src/rill/pull.dart';
...
<CodeSnippet snippet={PullSnippet} section="pull-anatomy" />
...
<CodeSnippet snippet={PullSnippet} section="pull-custom-combinator" />
