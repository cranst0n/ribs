...
import RillIOSnippet from '!!raw-loader!../../snippets/lib/src/rill_io/rill_io.dart';
...
<CodeSnippet snippet={RillIOSnippet} section="rill-io-files-read" />
...
<CodeSnippet snippet={RillIOSnippet} section="rill-io-files-write" />
...
<CodeSnippet snippet={RillIOSnippet} section="rill-io-net-client" />
...
<CodeSnippet snippet={RillIOSnippet} section="rill-io-net-server" />
...
<CodeSnippet snippet={RillIOSnippet} section="rill-io-realworld" />
