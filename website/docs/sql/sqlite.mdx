...
import SqliteSnippet from '!!raw-loader!../../snippets/lib/src/sql/sqlite.dart';
...
<CodeSnippet language="dart" title="SqliteTransactor" snippet={SqliteSnippet} section="sqlite-single"/>
...
<CodeSnippet language="dart" title="SqlitePoolTransactor" snippet={SqliteSnippet} section="sqlite-pool"/>
...
<CodeSnippet language="dart" title="End-to-end example" snippet={SqliteSnippet} section="sqlite-example"/>
