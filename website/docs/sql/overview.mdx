...
import SqlSnippet from '!!raw-loader!../../snippets/lib/src/sql/overview.dart';
...
<CodeSnippet language="dart" title="Domain model + codecs" snippet={SqlSnippet} section="sql-domain"/>
...
<CodeSnippet language="dart" title="Creating a Transactor" snippet={SqlSnippet} section="sql-transactor"/>
...
<CodeSnippet language="dart" title="Custom Strategy" snippet={SqlSnippet} section="sql-strategy"/>
...
<CodeSnippet language="dart" title="DDL with Update0" snippet={SqlSnippet} section="sql-ddl"/>
...
<CodeSnippet language="dart" title="Insert rows" snippet={SqlSnippet} section="sql-insert"/>
...
<CodeSnippet language="dart" title="Querying rows" snippet={SqlSnippet} section="sql-query"/>
...
<CodeSnippet language="dart" title="Reusable parameterized query" snippet={SqlSnippet} section="sql-parameterized"/>
...
<CodeSnippet language="dart" title="Streaming results" snippet={SqlSnippet} section="sql-stream"/>
...
<CodeSnippet language="dart" title="INSERT ... RETURNING" snippet={SqlSnippet} section="sql-returning"/>
...
<CodeSnippet language="dart" title="Composing and running a transaction" snippet={SqlSnippet} section="sql-transaction"/>
