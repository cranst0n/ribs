...
import IORetrySnippet from '!!raw-loader!../../../snippets/lib/src/core/effect/io_retry.dart';
...
* **isWorthRetrying**: Logic you can provide to inspect the `IOError` and
determine if the opration should be retried again, overriding the policy.
