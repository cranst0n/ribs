...
import StateSnippet from '!!raw-loader!../../snippets/lib/src/core/state.dart';
...
<CodeSnippet language="dart" title="Manual State Threading" snippet={StateSnippet} section="motivation-before" />
...
<CodeSnippet language="dart" title="Game State Model" snippet={StateSnippet} section="state-model" />
...
<CodeSnippet language="dart" title="State Operations" snippet={StateSnippet} section="state-ops" />
...
<CodeSnippet language="dart" title="Composing Operations" snippet={StateSnippet} section="state-compose" />
...
<CodeSnippet language="dart" title="Running the Computation" snippet={StateSnippet} section="state-run" />
...
<CodeSnippet language="dart" title="runA and runS" snippet={StateSnippet} section="state-runas" />
