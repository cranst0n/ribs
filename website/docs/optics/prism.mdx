...
import PrismSnippet from '!!raw-loader!../../snippets/lib/src/optics/prism.dart';
...
<CodeSnippet language="dart" title="Defining Prisms for a sealed hierarchy" snippet={PrismSnippet} section="prism-domain"/>

<CodeSnippet language="dart" title="Defining a Prism" snippet={PrismSnippet} section="prism-define"/>

## Using a Prism

<CodeSnippet language="dart" title="getOption / reverseGet / modify / replace" snippet={PrismSnippet} section="prism-use"/>
...
<CodeSnippet language="dart" title="andThenP — Prism + Prism → Prism" snippet={PrismSnippet} section="prism-compose"/>
