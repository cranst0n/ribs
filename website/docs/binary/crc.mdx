...
import CrcSnippet from '!!raw-loader!../../snippets/lib/src/binary/crc.dart';
...
<CodeSnippet language="dart" title="Crc — standard widths" snippet={CrcSnippet} section="crc-1"/>
...
<CodeSnippet language="dart" title="Crc — presets and custom parameters" snippet={CrcSnippet} section="crc-2"/>
...
<CodeSnippet language="dart" title="CrcBuilder — incremental checksum" snippet={CrcSnippet} section="crc-3"/>
