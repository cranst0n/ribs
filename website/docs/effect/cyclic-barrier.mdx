...
import CyclicBarrierSnippet from '!!raw-loader!../../snippets/lib/src/effect/cyclic_barrier.dart';
...
<CodeSnippet snippet={CyclicBarrierSnippet} section="cb-basic" />
...
<CodeSnippet snippet={CyclicBarrierSnippet} section="cb-reuse" />
...
<CodeSnippet snippet={CyclicBarrierSnippet} section="cb-cancel" />
...
<CodeSnippet snippet={CyclicBarrierSnippet} section="cb-pipeline" />
