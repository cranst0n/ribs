...
import CountDownLatchSnippet from '!!raw-loader!../../snippets/lib/src/effect/count_down_latch.dart';
...
<CodeSnippet snippet={CountDownLatchSnippet} section="cdl-basic" />
...
<CodeSnippet snippet={CountDownLatchSnippet} section="cdl-await-multiple" />
...
<CodeSnippet snippet={CountDownLatchSnippet} section="cdl-already-done" />
...
<CodeSnippet snippet={CountDownLatchSnippet} section="cdl-parallel-init" />
