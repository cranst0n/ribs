...
import RefSnippet from '!!raw-loader!../../snippets/lib/src/effect/ref.dart';
...
<CodeSnippet snippet={RefSnippet} section="basics" />
...
<CodeSnippet snippet={RefSnippet} section="modify" />

### Swapping values

`getAndSet` replaces the value and returns what was there before:

<CodeSnippet snippet={RefSnippet} section="get-and-set" />
...
<CodeSnippet snippet={RefSnippet} section="concurrent-counter" />
...
<CodeSnippet snippet={RefSnippet} section="request-cache" />
