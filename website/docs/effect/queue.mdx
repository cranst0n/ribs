...
import QueueSnippet from '!!raw-loader!../../snippets/lib/src/effect/queue.dart';
...
<CodeSnippet snippet={QueueSnippet} section="queue-basic" />
...
<CodeSnippet snippet={QueueSnippet} section="queue-backpressure" />
...
<CodeSnippet snippet={QueueSnippet} section="queue-pub-sub" />
