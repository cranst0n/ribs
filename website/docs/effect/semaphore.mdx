...
import SemaphoreSnippet from '!!raw-loader!../../snippets/lib/src/effect/semaphore.dart';
...
<CodeSnippet snippet={SemaphoreSnippet} section="semaphore-basic" />
...
<CodeSnippet snippet={SemaphoreSnippet} section="semaphore-permit" />
...
<CodeSnippet snippet={SemaphoreSnippet} section="semaphore-rate-limit" />
